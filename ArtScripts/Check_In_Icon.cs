...
{
    public partial class Check_In_Icon : Plant3DMainWin
    {
        private List<string> steps;

        public Check_In_Icon() // add the constructor name as filename for each dialog
        {
            this.Information = new TestCaseInformation(
                ...
                true,
                "Check_In_Icon",//Name define by persons who edit scripts , excel?
                new List<string> {
                    "GUID-A1F5DACD-DE82-4333-8418-1CA27D91C565"
				//Add the GUID here
				},
                FYRelease.FY16,
                true
            ...
            this.steps = new List<string> {
                "1. capture 'Check In' icon in ribbon (2nd icon from LHS of the product in Ribbon)",
