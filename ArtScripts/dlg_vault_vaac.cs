...
{
    public partial class dlg_vault_vaac : AutodeskVaultStandaloneClientDLG
    {

        public dlg_vault_vaac() // add the constructor name as filename for each dialog
        {
            this.Information = new TestCaseInformation(
                ...
                true,
                "dlg_vault_vaac",//Name define by persons who edit scripts , excel?
                new List<string> {
                    "GUID-50791C16-121F-459E-8EB2-8FB2CA8F8033"
				//Add the GUID here
				},
                FYRelease.FY16
            );
        ...
        {
            Current<AutodeskVaultStandaloneClientDLG>().CaptureBitmap(SaveLocation + this.Information.Items[0].ToString() + ArtEngineConstants.BitmapExtension);
        }
