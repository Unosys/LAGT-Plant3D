...
{
    public partial class Collaboration_Share_Project_Icon : Plant3DMainWin
    {
        private List<string> steps;

        public Collaboration_Share_Project_Icon() // add the constructor name as filename for each dialog
        {
            this.Information = new TestCaseInformation(
                ...
                true,
                "Collaboration_Share_Project_Icon",//Name define by persons who edit scripts , excel?
                new List<string> {
                    "GUID-EDE7D235-4D62-4F84-A36D-CEB9C369FBEC"
				//Add the GUID here
				},
                FYRelease.FY16,
                true
            ...
            this.steps = new List<string> {
                "1. capture 'Share Project' icon in ribbon (1st icon in Ribbon)",
