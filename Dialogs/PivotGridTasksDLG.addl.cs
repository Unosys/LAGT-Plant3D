...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PivotGridTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(15);//Click 'Pivot Grid' in the 'Tool Box'
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\PivotGrid.bmp");
            Desktop.DoubleClick(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 2, ProductTestSuite.CommonFiles.SAM.iYCoord + 2);
            ...
            bool exist = PivotGridTasksDLG.Exists;
			if (!exist)
			{
                Desktop = new Desktop();
                Desktop.Click(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 2, ProductTestSuite.CommonFiles.SAM.iYCoord + 2);
			...
			exist = PivotGridTasksDLG.Exists;
			if (!exist)
			{
                Desktop = new Desktop();
                Desktop.Click(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 2, ProductTestSuite.CommonFiles.SAM.iYCoord + 2);
