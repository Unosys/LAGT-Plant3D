...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectDrawingsToCopyToProDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "[DialogBox]" + AcMainWin.cBabel(23072,1,"Select Drawings to Copy to Project");
		}
		...
		public override void Invoke()
		{
            ...
            ////window wTreeView = PROJECTMANAGERDLG.M_treeView; //PRADIP - we should directly use the TreeView.Expand()..
		...
		public override void Dismiss()
		{
			...
			SelectDrawingsToCopyToProDLG.Cancel.Click();
			PROJECTMANAGERDLG PROJECTMANAGERDLG = new PROJECTMANAGERDLG();
