...
{
    public partial class SubreportTasksDLG : Pane
    {
		...
		{
            Tag = "Subreport|#1"; // "DevExpress.XtraReports.Design.XRSmartTagService+PopupForm";
		}
		...
		public  void Invoke()
		{
			...
			//Plant3DFunctions.StandardControls(16);
			System.Threading.Thread.Sleep(4000);
            Desktop Desktop = new Desktop();
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Subreport.bmp");
