...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupP3DPathsDLG : Pane
    {
		...
		public  void Invoke()
		{
            //No need to execute this dialog as is merged to ProjectSetupGeneralSettingsPathsDLG
            ...
            //ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(21047, 1, "Plant 3D DWG Settings") + "/" + AcMainWin.cBabel(21014, 1, "Paths"));
			ProjectSetupProjectDetailsDLG.PathsTVI.Click();
