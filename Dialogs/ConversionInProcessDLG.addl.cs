...
{
    public partial class ConversionInProcessDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        {
            Tag = "[DialogBox]Sharing Project to the Cloud|*" + AcMainWin.cBabel(23073, 32, "Sharing Project to the Cloud") + "*|[DialogBox]#1";
        ...
        {       
            ...
            PlantProjectCollaborationUploadingProcessDLG.Invoke();
        ...
        public override void Dismiss()
        {
            ...
            //Current<ConversionInProcessDLG>().TypeKeys("<Tab><Enter>");
            this.StopSharingMyProjectPB.Click();
