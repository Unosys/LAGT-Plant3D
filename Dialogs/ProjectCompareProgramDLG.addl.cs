...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectCompareProgramDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            ProjectCompare.TreeViewTV.Select(AcMainWin.cBabel(23069, 5, "Iso Styles"));
            ProjectCompare.CheckANSIBLBI.Click(MouseButton.Left, 1, 1);
            ////ProjectCompare.Isoatr.Click(MouseButton.Left, 1, 1); 
            //ProjectCompare.Isodwt.Click(MouseButton.Left, 1, 1);
            ////ProjectCompare.IsoConfig.Click(MouseButton.Left, 1, 1);
            //if (ProjectCompare.SetupComparePB.IsEnabled==true) {
            //    ProjectCompare.SetupComparePB.Click();
            //}
            System.Threading.Thread.Sleep(3000);
            ProjectCompare.CheckANSIBFilesLB.Select("IsoConfig.xml");//
            System.Threading.Thread.Sleep(1000);
            ProjectCompare.SetupComparePB.Click();
            ProjectCompareProgramDLG ProjectCompareProgramDLG = new ProjectCompareProgramDLG();
            ProjectCompareProgramDLG.SetActive();
		...
		{
            ProjectCompareProgramDLG ProjectCompareProgramDLG = new ProjectCompareProgramDLG();
            ProjectCompareProgramDLG.CancelPB.Click();
            ProjectCompare ProjectCompare = new ProjectCompare();
            ProjectCompare.Dismiss();
		}
    }
}
