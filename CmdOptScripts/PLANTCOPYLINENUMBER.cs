...
{
	public class PLANTCOPYLINENUMBERCLASS
    {
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTCOPYLINENUMBER = new List<Command>
		{
			new PLANTCOPYLINENUMBER(),
			new PLANTCOPYLINENUMBER_OFF(),
			new PLANTCOPYLINENUMBER_ON()
		};
	}

	public class PLANTCOPYLINENUMBER : Command
	{
		public override void Launch()
		{
		
            CmdOpt_Engine.SendCmd("PLANTCOPYLINENUMBER");
        }
	...
	public class PLANTCOPYLINENUMBER_OFF : PLANTCOPYLINENUMBER
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTCOPYLINENUMBER");
	...
	public class PLANTCOPYLINENUMBER_ON : PLANTCOPYLINENUMBER
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTCOPYLINENUMBER");
