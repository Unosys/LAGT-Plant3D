...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SaveTemplateToDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            //Tag = AcMainWin.cBabel(23073, 16, "Save Template To*");
              Tag = Plant3DFunctions.GetLocString("SaveTemplateTo");
        ...
        public override void Invoke()
        {
            ...
            P3DCreateEquipmentDLG.TemplatesPB.Click();
            P3DCreateEquipmentDLG.TypeKeys("<Down 2><Enter>");
            this.SetActive();
        }
