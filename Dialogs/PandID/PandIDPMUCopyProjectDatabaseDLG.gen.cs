...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class PandIDPMUCopyProjectDatabaseDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  PushButton CopyBrowseBtn;
        public  GroupBox CopyGroup;
        public  TextField CopyPjtPathTB;
        ...
        private void InitializeComponent()
        {
            ...
            CopyBrowseBtn = new PushButton()
            {
                Tag = "[Pane]$DetailsControl|#1/[GroupBox]Copy details |$CopyGroup|#1/[PushButton]Browse*|$CopyBrowseBtn|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CopyBrowseBtn);

            CopyGroup = new GroupBox()
            {
                Tag = "[GroupBox]$CopyGroup",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CopyGroup);

            CopyPjtPathTB = new TextField()
            {
                Tag = "[TextField]$CopyPjtPathTB",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CopyPjtPathTB);
            ...
            {
                Tag = "[Pane]$DetailsControl|#1/[PushButton]Copy|$DoBtn|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            Label7 = new StaticText()
            {
                Tag = "[StaticText]$label7",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(Label7);
            ...
            ServerListCombboxTextField = new TextField()
            {
