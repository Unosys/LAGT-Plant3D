...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ClassDefinitionOrSymbolNameRequiredDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			AddSymbolsEditSymbolSettingsDLG.SetActive();
		...
		public override void Dismiss()
		{
			...
			ClassDefinitionOrSymbolNameRequiredDLG.SetActive();
			ClassDefinitionOrSymbolNameRequiredDLG.Cancel.Click();
			AddSymbolsEditSymbolSettingsDLG AddSymbolsEditSymbolSettingsDLG = new AddSymbolsEditSymbolSettingsDLG();
			AddSymbolsEditSymbolSettingsDLG.Dismiss();
		}
    }
}
