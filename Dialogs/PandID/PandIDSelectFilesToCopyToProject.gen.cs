...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Files to Copy to Project", Parent = typeof(CustomWin))]
    public partial class PandIDSelectFilesToCopyToProject : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public PandIDSelectFilesToCopyToProject()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[CustomWin]#1/[ListView]$1|#1/[Header]Header|$Header|#1/[CustomWin]Size|$HeaderItem 3|#4",
                ParentType = this.GetType(),
                Parent = this
            };
