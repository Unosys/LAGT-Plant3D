...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SpecUpdateSynchronizationCompleteUpdatedSpecsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            SpecUtilityOpenSpecDLG.FileName1.SetText(LAGT.CommonFiles.Product.Variables.TestFilesDir + "CS150 Flanged.pspx");
		...
		{
			SpecUpdateSynchronizationCompleteUpdatedSpecsDLG SpecUpdateSynchronizationCompleteUpdatedSpecsDLG = new SpecUpdateSynchronizationCompleteUpdatedSpecsDLG();
			SpecUpdateSynchronizationCompleteUpdatedSpecsDLG.SetActive();
			SpecUpdateSynchronizationCompleteUpdatedSpecsDLG.CloseButton.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
