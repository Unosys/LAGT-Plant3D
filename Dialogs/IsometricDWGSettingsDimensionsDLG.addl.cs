...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class IsometricDWGSettingsDimensionsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            //ProjectSetupIsometricDWGSettingsDLG.DimensionsTVI.Click();
            ProjectSetupProjectDetailsDLG ProjectSetupProjectDetailsDLG = new ProjectSetupProjectDetailsDLG();
            ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(23035, 5, "Isometric DWG Settings") + "/" + AcMainWin.cBabel(21043, 1, "Dimensions"));
		...
		public override void Dismiss()
		{
            ...
            IsometricDWGSettingsDimensionsDLG.CancelPB.Click();
		}
    }
}
