...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupWizardFinishVaultDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG.Invoke();
		}

		public override void Dismiss()
		{
			ProjectSetupWizardFinishVaultDLG ProjectSetupWizardFinishVaultDLG = Current<ProjectSetupWizardFinishVaultDLG>();
            ProjectSetupWizardFinishVaultDLG.ClosePB.Click();
