...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PageInfoTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(14);
            System.Threading.Thread.Sleep(4000);
            Desktop Desktop = new Desktop();
            //ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Down.bmp");
            //Desktop.PressMouse(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
            //System.Threading.Thread.Sleep(3000);
            //Desktop.ReleaseMouse(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
            System.Threading.Thread.Sleep(1000);
            ToolBoxDLG ToolBoxDLG = new ToolBoxDLG();
            ToolBoxDLG.ItemMI.PressMouse(MouseButton.Left,1,1);
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\PageInfo.bmp");
