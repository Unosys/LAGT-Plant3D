...
{
	public class PLANTISOLATECLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTISOLATE = new List<Command>
		{
			new PLANTISOLATE()
		};
	}

	public class PLANTISOLATE : Command
	{
		public override void Launch()
		{
			...
			CmdOpt_Engine.EnterPoint(1000,300);
			...
			CmdOpt_Engine.SendCmd("PLANTISOLATE");
		}
		...
		public override void Verify()
		{
			...
			if (!sCmdOpt.Contains("1"))
			{
				CmdOpt_ErrorReport.tError sError = new CmdOpt_ErrorReport.tError("CMD_NOT_WORKING", "1 object should have been isolated'.", "", "", "");
