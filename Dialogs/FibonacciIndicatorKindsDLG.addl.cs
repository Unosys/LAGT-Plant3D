...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class FibonacciIndicatorKindsDLG : Pane
    {
		...
		{
			FibonacciIndicatorKindsDLG FibonacciIndicatorKindsDLG = new FibonacciIndicatorKindsDLG();
			FibonacciIndicatorKindsDLG.SetActive();
            FibonacciIndicatorKindsDLG.CancelPB.Click();
            ChartWizardSeriesViewsGeneralDLG ChartWizardSeriesViewsGeneralDLG = Current<ChartWizardSeriesViewsGeneralDLG>();
            ChartWizardSeriesViewsGeneralDLG.SetActive();
            ChartWizardSeriesViewsGeneralDLG.Dismiss();
		}
    }
}
