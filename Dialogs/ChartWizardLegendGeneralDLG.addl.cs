...
{
    public partial class ChartWizardLegendGeneralDLG : Pane
    {
		...
		public  void Invoke()
		{
			...
			Plant3DFunctions.ChartWizardPresentation(11);
			ChartWizardLegendGeneralDLG ChartWizardLegendGeneralDLG = new ChartWizardLegendGeneralDLG();
			ChartWizardLegendGeneralDLG.SetActive();
		}
		...
		public  void Dismiss()
		{
			ChartWizardLegendGeneralDLG ChartWizardLegendGeneralDLG = new ChartWizardLegendGeneralDLG();
			ChartWizardLegendGeneralDLG.SetActive();
			ChartWizardLegendGeneralDLG.TypeKeys("<Alt-F4>");
