...
{
    public partial class PandIDProjectMoveFailedDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "[DialogBox]" + AcMainWin.cBabel(23032,7,"Project Move Failed");
		}
		...
		public override void Invoke()
		{
            ...
            PandIDPMUMoveProjectDatabaseDLG.DbPrefixTxt.TypeKeys("<end>*");
