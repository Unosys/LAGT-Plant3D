...
{
    public partial class PandIDNoBlockSpecifiedMSG : AcDialogBox
    {
        ...
        {
            Tag = "[DialogBox]" + AcMainWin.cBabel(21010, 2, "No Block Specified");
        }
        ...
        public override void Invoke()
        {
            ...
            PandIDNewEndConnectionDLG.M_textBoxName.SetText("ED2");
