...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDStandardsCentrifugalBlowerDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            PandIDProjectSetupPandIDClassDefinitionDLG.M_dataGridView0.Click();
            System.Threading.Thread.Sleep(1000);
            PandIDProjectSetupPandIDClassDefinitionDLG.TypeKeys("<Down 19>");
            PandIDProjectSetupPandIDClassDefinitionDLG.M_btnEditProperties.Click();
