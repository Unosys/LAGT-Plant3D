...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDProjectConversionFailedDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[DialogBox]" + AcMainWin.cBabel(23032, 4, "Project Conversion Failed");
		}
        ...
        public override void Invoke()
        {
            ...
            PandIDOpenReportCreatorProjectDLG PandIDOpenReportCreatorProjectDLG = new PandIDOpenReportCreatorProjectDLG();
            ...
            PandIDOpenReportCreatorProjectDLG.FileNameCB.SetText(LAGT.CommonFiles.Product.Variables.TestFilesDir + projectName + "\\" + "Project.xml");
            PandIDOpenReportCreatorProjectDLG.OpenPB.Click();
            PandIDPMUConvertProjectToSQLExpressDLG.DbPrefixTxt.TypeKeys("<end>a");
            PandIDPMUConvertProjectToSQLExpressDLG.DoBtn.Click();
