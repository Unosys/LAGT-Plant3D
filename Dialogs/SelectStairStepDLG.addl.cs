...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectStairStepDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23019, 1, "Select Step");
            //Tag = "Select Step";            
		}
		...
		public override void Invoke()
		{
            ...
            StairSettingsDLG.StepData.Click();
		}

		public override void Dismiss()
		{
			SelectStairStepDLG SelectStairStepDLG = new SelectStairStepDLG();
			SelectStairStepDLG.Cancel.Click();
			StairSettingsDLG StairSettingsDLG = new StairSettingsDLG();
