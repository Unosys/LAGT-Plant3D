...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ReportDesignerOpenDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(250, 14, "Open");
		}
		...
		public override void Invoke()
		{
			...
			ReportDesignerApplicationDLG.Click(MouseButton.Left, 180, 35);
			System.Threading.Thread.Sleep(4000);
			ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\FileOpen3_Button.bmp");
