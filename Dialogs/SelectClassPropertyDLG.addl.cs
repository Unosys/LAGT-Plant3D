...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectClassPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = AcMainWin.cBabel(21070,5,"Select Class Property");
		}
		...
		{
			SelectClassPropertyDLG SelectClassPropertyDLG = new SelectClassPropertyDLG();
			SelectClassPropertyDLG.Cancel.Click();
			DataManagerConfigurationDLG DataManagerConfigurationDLG = new DataManagerConfigurationDLG();
			DataManagerConfigurationDLG.Dismiss();
		}
    }
}
