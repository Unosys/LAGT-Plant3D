...
{
    public partial class ProjectCompareSpecSheetsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            ProjectCompareSpecSheetsDLG ProjectCompareSpecSheetsDLG = new ProjectCompareSpecSheetsDLG();
            ProjectCompareSpecSheetsDLG.TreeViewTV.Select(AcMainWin.cBabel(23069, 16, "Spec Sheets"));
            System.Threading.Thread.Sleep(1000);
            Desktop.Current.TypeKeys("<Down>");
            ProjectCompareSpecSheetsDLG.CS150LBI.Click(MouseButton.Left, 1, 1);
        }
