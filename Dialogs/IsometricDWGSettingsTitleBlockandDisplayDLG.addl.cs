...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class IsometricDWGSettingsTitleBlockandDisplayDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			//ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(23035,5,"Isometric DWG Settings")+"/"+AcMainWin.cBabel(23035,9,"Title Block and Display"));
			ProjectSetupProjectDetailsDLG.TitleBlockAndDisplay1TVI.Click();
