...
{
    public partial class EquipmentPlatformDLG : Pane
    {
        ...
        public void Invoke()
        {
            ...
            P3DCreateEquipmentDLG.TypeKeys("<Down 4><Enter>");
            RECT rWin = P3DCreateEquipmentDLG.GetRect();
            P3DCreateEquipmentDLG.PressMouse(MouseButton.Left, 100, rWin.yPos);
            System.Threading.Thread.Sleep(100);
            Desktop.Current.ReleaseMouse(MouseButton.Left, 100, 10);
            System.Threading.Thread.Sleep(100);
            P3DCreateEquipmentDLG.PressMouse(MouseButton.Left, 100, rWin.ySize);
            System.Threading.Thread.Sleep(100);
            Desktop.Current.ReleaseMouse(MouseButton.Left, 100, 930);
            System.Threading.Thread.Sleep(100);
