...
{
    public partial class EditStairDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23007, 1, "Edit Stair");
		}
		...
		public override void Invoke()
		{
			...
			Drawing.Current.TypeE("20,100");
			Drawing.Current.TypeE("20,50");
			...
			Drawing.Current.TypeE("38.09,70.11");
		}

		public override void Dismiss()
		{
			EditStairDLG EditStairDLG = new EditStairDLG();
			EditStairDLG.Cancel.Click();
