...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class EditFootingDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23014, 4, "Edit Footing");
		}
		...
		public override void Invoke()
		{
			...
			Drawing.Current.TypeE("60,80");
			Drawing.Current.TypeE("_PlantSteelEdit");
			Drawing.Current.TypeE("_last");
            EditFootingDLG EditFootingDLG = new EditFootingDLG();
            EditFootingDLG.SetActive();
		}

		public override void Dismiss()
		{
			EditFootingDLG EditFootingDLG = new EditFootingDLG();
			EditFootingDLG.TypeKeys("<Esc>");
