...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]$SelectDrawingPropertyDlg", Parent = typeof(Plant3D))]
    public partial class SelectDrawingPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectDrawingPropertyDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
