...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ChartWizardDiagramElementsAddDLG : Pane
    {
		...
		public  void Invoke()
		{
			...
			ChartWizardDataPointsDLG ChartWizardDataPointsDLG = new ChartWizardDataPointsDLG();
			ChartWizardDataPointsDLG.SetActive();
		}
		...
		public  void Dismiss()
		{
			ChartWizardDataPointsDLG ChartWizardDataPointsDLG = new ChartWizardDataPointsDLG();
			ChartWizardDataPointsDLG.SetActive();
			ChartWizardDataPointsDLG.TypeKeys("<Alt-F4>");
