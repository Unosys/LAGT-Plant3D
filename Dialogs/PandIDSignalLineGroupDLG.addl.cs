...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
	public partial class PandIDSignalLineGroupDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
	{
		...
		public override void Invoke()
		{
			...
			ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(21030, 1, "P&ID DWG Settings") + "/" + AcMainWin.cBabel(21013, 1, "P&ID Class Definitions") + "/" + AcMainWin.cBabel(21100, 17, "Signal Line Group"));
			System.Threading.Thread.Sleep(10000);
			this.SetActive();
		}
