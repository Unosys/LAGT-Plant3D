...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PIDLineSettingsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(21012, 1, "Line Settings")+"|#1";
		}

		public override void Invoke()
		{
			ProjectSetupPIDLineDLG ProjectSetupPIDLineDLG = new ProjectSetupPIDLineDLG();
			ProjectSetupPIDLineDLG.Invoke();
			ProjectSetupPIDLineDLG.BtnLineSettings.Click();

            if (!this.Exists) {
                ProjectSetupEndConnectionDLG ProjectSetupEndConnectionDLG = new ProjectSetupEndConnectionDLG();
                ProjectSetupEndConnectionDLG.M_treeView.TypeKeys("<right><Down>");
                ProjectSetupPIDLineDLG.BtnLineSettings.Click();
            }
		}
		...
		public override void Dismiss()
		{
			this.Cancel.Click();
			ProjectSetupPIDLineDLG ProjectSetupPIDLineDLG = new ProjectSetupPIDLineDLG();
			ProjectSetupPIDLineDLG.Dismiss();
		}
    }
}
