...
{
	public class PLANTPIPESUPPORTATTACHCLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTPIPESUPPORTATTACH = new List<Command>
		{
			new PLANTPIPESUPPORTATTACH()
		};
	}

	public class PLANTPIPESUPPORTATTACH : Command
	{
		public override void Launch()
		{
			...
			//Drawing.Current.TypeKeys("<ESC>");
			CmdOpt_Engine.SendCmd("PLANTPIPESUPPORTATTACH");
		}
