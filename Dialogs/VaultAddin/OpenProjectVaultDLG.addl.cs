...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class OpenProjectVaultDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			System.Threading.Thread.Sleep(2000);
			OpenProjectVaultDLG OpenProjectVaultDLG = Current<OpenProjectVaultDLG>();
			OpenProjectVaultDLG.SetActive();
		}
		...
		public override void Dismiss()
		{
			OpenProjectVaultDLG OpenProjectVaultDLG = Current<OpenProjectVaultDLG>();
			OpenProjectVaultDLG.SetActive();
			OpenProjectVaultDLG.M_btnCancel.Click();
