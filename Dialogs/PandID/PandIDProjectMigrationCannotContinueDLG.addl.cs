...
{
    public partial class PandIDProjectMigrationCannotContinueDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "[DialogBox]" + AcMainWin.cBabel(21067,1,"Project Migration Cannot Continue");
		}

		public override void Invoke()
		{
			PandIDAutoCADPIDMigration2009DLG PandIDAutoCADPIDMigration2009DLG = new PandIDAutoCADPIDMigration2009DLG();
            PandIDAutoCADPIDMigration2009DLG.Invoke();
            PandIDAutoCADPIDMigration2009DLG.SetActive();
            PandIDAutoCADPIDMigration2009DLG.TypeKeys("<Enter>");
           // PandIDAutoCADPIDMigration2009DLG.NextPB.Click();
            ...
            PandIDProjectMigrationCannotContinueDLG.SetActive();
		}
