...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PrintPreviewapplicationDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            SpecEditorDLG.PrintPreview.Pick();
			PrintPreviewapplicationDLG PrintPreviewapplicationDLG = new PrintPreviewapplicationDLG();
			PrintPreviewapplicationDLG.SetActive();
		}

		public override void Dismiss()
		{
			PrintPreviewapplicationDLG PrintPreviewapplicationDLG = new PrintPreviewapplicationDLG();
            PrintPreviewapplicationDLG.ClosePB.Click();
