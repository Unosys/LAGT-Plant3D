...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ChartWizardApearanceDLG : Autodesk.GUIHarness.Pane
    {
		...
		public  void Invoke()
		{
            ...
            Plant3DFunctions.construction(2);
			System.Threading.Thread.Sleep(5000);
			ChartWizardApearanceDLG ChartWizardApearanceDLG = new ChartWizardApearanceDLG();
			ChartWizardApearanceDLG.SetActive();
		}
		...
		public  void Dismiss()
		{
			ChartWizardApearanceDLG ChartWizardApearanceDLG = new ChartWizardApearanceDLG();
			ChartWizardApearanceDLG.SetActive();
			ChartWizardApearanceDLG.TypeKeys("<Alt-F4>");
			ReportDesignerApplicationDLG ReportDesignerApplicationDLG = new ReportDesignerApplicationDLG();
			ReportDesignerApplicationDLG.SetActive();
