...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class P3DTagSelectProjectAutogenerationDLG : Pane
    {
		...
		public  void Invoke()
		{
			...
			P3DTagDefineExpressionDLG.M_projectFieldRadioButton.Click();
			P3DTagDefineExpressionDLG.M_projectFieldButton.Click();
		}

		public  void Dismiss()
		{
			P3DTagSelectProjectAutogenerationDLG P3DTagSelectProjectAutogenerationDLG = new P3DTagSelectProjectAutogenerationDLG();
			P3DTagSelectProjectAutogenerationDLG.M_btnCancel.Click();
			P3DTagDefineExpressionDLG P3DTagDefineExpressionDLG = new P3DTagDefineExpressionDLG();
