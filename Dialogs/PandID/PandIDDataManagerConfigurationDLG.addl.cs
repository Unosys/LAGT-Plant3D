...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDDataManagerConfigurationDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            PandIDFunctions.treeViewExpand(PandIDProjectSetupEndConnectionDLG.M_treeView, AcMainWin.cBabel(21030, 1, "P&ID DWG Settings"));
            PandIDFunctions.treeViewSelect(PandIDProjectSetupEndConnectionDLG.M_treeView, AcMainWin.cBabel(21001, 1, "Data Manager Configuration"));
        }
		public override void Dismiss()
		{
            PandIDProjectSetupProjectDetailsDLG PandIDProjectSetupPathsDLG = new PandIDProjectSetupProjectDetailsDLG();
			PandIDProjectSetupPathsDLG.Dismiss();
		}
    }
}
