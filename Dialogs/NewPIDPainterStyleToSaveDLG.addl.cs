    ...
    public partial class NewPIDPainterStyleToSaveDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            ProjectSetupPIDPainterSettingsDLG.SetActive();
             ProjectSetupPIDPainterSettingsDLG.AddPB.Click();
        }

        public override void Dismiss()
        {
            NewPIDPainterStyleToSaveDLG NewPIDPainterStyleToSaveDLG = new NewPIDPainterStyleToSaveDLG();
            NewPIDPainterStyleToSaveDLG.CancelPB.Click();
            ProjectSetupPIDPainterSettingsDLG ProjectSetupPIDPainterSettingsDLG = new ProjectSetupPIDPainterSettingsDLG();
