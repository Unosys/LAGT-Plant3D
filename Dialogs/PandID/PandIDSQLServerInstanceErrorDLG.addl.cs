...
{
    public partial class PandIDSQLServerInstanceErrorDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.M_comboServer.SetText("");
