...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class IsoSaveChangesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23053, 52, "Save Changes") + "*|*"+ AcMainWin.cBabel(23062, 3, "Save")+"*";
        }
		...
		public override void Invoke()
		{
            ...
            IsometricDWGSettingsIsoStyleSetupDLG.RadioButton1RB.Click();
            //IsometricDWGSettingsIsoStyleSetupDLG.ToContinueLongTables2RB.Click();
