...
{
	public class PLANTLINELISTUSEGSFCLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTLINELISTUSEGSF = new List<Command>
		{
			new PLANTLINELISTUSEGSF(),
			new PLANTLINELISTUSEGSF_OFF(),
			new PLANTLINELISTUSEGSF_ON()
		};
	}

	public class PLANTLINELISTUSEGSF : Command
	{
		public override void Launch()
		{
			
            CmdOpt_Engine.SendCmd("PLANTLINELISTUSEGSF");
        }
	...
	public class PLANTLINELISTUSEGSF_OFF : PLANTLINELISTUSEGSF
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTLINELISTUSEGSF");
	...
	public class PLANTLINELISTUSEGSF_ON : PLANTLINELISTUSEGSF
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTLINELISTUSEGSF");
