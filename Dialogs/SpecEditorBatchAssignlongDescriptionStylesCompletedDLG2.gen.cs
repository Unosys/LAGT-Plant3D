...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class SpecEditorBatchAssignlongDescriptionStylesCompletedDLG2 : Autodesk.GUIHarness.Window
    {
        ...
        public  StaticText LongDescriptionFamilyHasST;

        partial void OnInitialize();

        public SpecEditorBatchAssignlongDescriptionStylesCompletedDLG2()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            LongDescriptionFamilyHasST = new StaticText()
            {
                Tag = "[StaticText]Long Description (Family) has been set to Default Part Family Style*|$MessageTexBlockt|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(LongDescriptionFamilyHasST);
        }
    }
}
