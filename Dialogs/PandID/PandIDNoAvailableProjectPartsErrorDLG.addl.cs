...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDNoAvailableProjectPartsErrorDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PandIDProjectConversionSuccessDLG.Invoke();
			PandIDProjectConversionSuccessDLG.SetActive();
			PandIDProjectConversionSuccessDLG.OK.Click();
			PandIDPMUConvertProjectToSQLExpressDLG PandIDPMUConvertProjectToSQLExpressDLG = Current<PandIDPMUConvertProjectToSQLExpressDLG>();
			...
			PandIDOpenReportCreatorProjectDLG.Cancel.Click();
