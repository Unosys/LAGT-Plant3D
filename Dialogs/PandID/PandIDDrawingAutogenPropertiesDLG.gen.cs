...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]$frmDWGAutogenProperties", Parent = typeof(CustomWin))]
    public partial class PandIDDrawingAutogenPropertiesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public PandIDDrawingAutogenPropertiesDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
