...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]ControlValveBrowserDLG", Parent = typeof(Plant3D))]
    public partial class PandIDControlValveBrowserDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public PandIDControlValveBrowserDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
