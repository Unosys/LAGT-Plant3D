...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectPreviewFileDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23071, 5, "Select Preview File")+"|#1";
		}
		...
		public override void Invoke()
		{
			...
			AutoCADPlant3DCatalogBuilderApplicationDLG.SelectPreviewImageBtn.Click();
		}

		public override void Dismiss()
		{
			SelectPreviewFileDLG SelectPreviewFileDLG = new SelectPreviewFileDLG();
			SelectPreviewFileDLG.SetActive();
			SelectPreviewFileDLG.Cancel.Click();
			AutoCADPlant3DCatalogBuilderApplicationDLG AutoCADPlant3DCatalogBuilderApplicationDLG = new AutoCADPlant3DCatalogBuilderApplicationDLG();
