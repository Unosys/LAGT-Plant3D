...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDProjectSetupLineSettingsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PandIDProjectSetupEndConnectionDLG.Invoke();
			PandIDProjectSetupEndConnectionDLG.M_treeView.Select(AcMainWin.cBabel(21030,1,"P&ID DWG Settings") + "/" + AcMainWin.cBabel(21012,1,"Line Settings"));
		}

		public override void Dismiss()
		{
			PandIDProjectSetupProjectDetailsDLG PandIDProjectSetupProjectDetailsDLG = Current<PandIDProjectSetupProjectDetailsDLG>();
