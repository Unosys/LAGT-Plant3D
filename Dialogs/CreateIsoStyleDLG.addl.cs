...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class CreateIsoStyleDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		partial void OnInitialize()
		{
            ...
            Tag = "[Pane]Create Iso Style|$CreateNewIsoType";
		}
        ...
        public override void Invoke()
		{
			...
			//IsometricDWGSettingsIsoStyleSetupDLG.TypeKeys("<Tab 3>");
			//IsometricDWGSettingsIsoStyleSetupDLG.TypeKeys("<Enter>");
			IsometricDWGSettingsIsoStyleSetupDLG.PushButton3PB.Click();
			System.Threading.Thread.Sleep(1000);
			IsoSaveChangesDLG IsoSaveChangesDLG = new IsoSaveChangesDLG();
			if (IsoSaveChangesDLG.Exists) {
				IsoSaveChangesDLG.SavePB.Click();
			}
			CreateIsoStyleDLG CreateIsoStyleDLG = new CreateIsoStyleDLG();
			CreateIsoStyleDLG.SetActive();
		}

        public override void Dismiss()
		{
			CreateIsoStyleDLG CreateIsoStyleDLG = new CreateIsoStyleDLG();
            CreateIsoStyleDLG.CancelPB.Click();
