...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupPulledPipeBendDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            //ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(21047, 1, "Plant 3D DWG Settings") + AcMainWin.cBabel(21051, 1, "Plant 3D Class Definitions") + "/" + AcMainWin.cBabel(23031, 12, "Pulled Pipe Bend"));
            ProjectSetupProjectDetailsDLG.PulledPipeBendTVI.Click();
            ProjectSetupProjectDetailsDLG.SetActive();
        }

        public override void Dismiss()
        {
            ProjectSetupPulledPipeBendDLG ProjectSetupPulledPipeBendDLG = new ProjectSetupPulledPipeBendDLG();
            ProjectSetupPulledPipeBendDLG.CancelPB.Click();
