...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDProjectSetupEndConnectionDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            //PandIDFunctions.treeViewSelect(PandIDProjectSetupEndConnectionDLG.M_treeView, AcMainWin.cBabel(21009, 1, "End Connections"));
            PandIDProjectSetupProjectDetailsDLG.DisplaySettingsTVI.Click();
