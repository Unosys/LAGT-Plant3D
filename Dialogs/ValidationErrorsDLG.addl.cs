...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ValidationErrorsDLG : Pane
    {
		...
		public void Invoke()
		{
			...
			if (NewReportConfigurationDLG.Exists)
		...
		public void Dismiss()
		{
			ValidationErrorsDLG ValidationErrorsDLG = new ValidationErrorsDLG();
			ValidationErrorsDLG.SetActive();
			ValidationErrorsDLG.M_oKBtn.Click();
			ReportConfigurationDLG ReportConfigurationDLG = new ReportConfigurationDLG();
