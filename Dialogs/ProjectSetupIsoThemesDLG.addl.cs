...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupIsoThemesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            //ProjectSetupIsometricDWGSettingsDLG.ThemesTVI.Click();
            ProjectSetupIsometricDWGSettingsDLG.TreeViewTV.Select(AcMainWin.cBabel(23035, 5, "Isometric DWG Settings")+"/"+ AcMainWin.cBabel(21067, 3, "Themes"));
        ...
        public override void Dismiss()
		{
            ...
            ProjectSetupIsoThemesDLG.CancelPB.Click();
		}
    }
}
