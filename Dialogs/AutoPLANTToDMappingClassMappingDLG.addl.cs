...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AutoPLANTToDMappingClassMappingDLG : Window
    {
		...
		public void Invoke()
		{
			...
			SpecEditorDLG.AutoPlantSetting.Pick();
            ...
            //AutoPLANTToDMappingClassMappingDLG.ClassMappingWIN.Click();
		...
		public void Dismiss()
		{
			AutoPLANTToDMappingClassMappingDLG AutoPLANTToDMappingClassMappingDLG = new AutoPLANTToDMappingClassMappingDLG();
			AutoPLANTToDMappingClassMappingDLG.SetActive();
			AutoPLANTToDMappingClassMappingDLG.CancelPB.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
			SpecEditorDLG.SetActive();
