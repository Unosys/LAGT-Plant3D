...
{
    public partial class EditLadderDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23014, 2, "Edit Ladder");
		}
		...
		public override void Invoke()
		{
			...
			Drawing.Current.TypeE("_PlantSteelLadder");
			Drawing.Current.TypeE("60,100");
			Drawing.Current.TypeE("60,40");
			Drawing.Current.TypeE("90,50");
			Drawing.Current.TypeE("_Zoom");
			Drawing.Current.TypeE("_Extents");
			Drawing.Current.TypeE("_PlantSteelEdit");
			Drawing.Current.TypeE("90,20");
		}
