...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AutoCADPlant3DMigrationDLG : Pane
    {
        ...
        public void Invoke()
        {
            ...
            string sProductInstalledPath;
            string sTemp;
                string sProjectName;
            sProjectName = LAGT.CommonFiles.Product.Variables.TestFilesDir+"Project 1\\Project.xml";
        ...
        public void Dismiss()
        {
            //Desktop.Current.TypeKeys("<Esc><enter>");
            AutoCADPlant3DMigrationDLG AutoCADPlant3DMigrationDLG = new AutoCADPlant3DMigrationDLG();
            AutoCADPlant3DMigrationDLG.SetActive();
            ...
            MigrationCancelTaskDLG.ExitPB.Click();
