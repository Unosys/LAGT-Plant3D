...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class LoadViewDLG : Pane
    {
		...
		{
			Tag = "[Pane]" + AcMainWin.cBabel(23052,1,"Load View");
		}
		...
		public void Invoke()
		{
            ...
            if (AppWnd.LoadOrthoCubePB.Exists)
            {
                AppWnd.LoadOrthoCubePB.Click();
            }
            if (!this.Exists)
            {
                ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Loadview.bmp");
        ...
        public void Dismiss()
		{
			LoadViewDLG LoadViewDLG = new LoadViewDLG();
            LoadViewDLG.Cancel.Click();
            System.Threading.Thread.Sleep(2000);
