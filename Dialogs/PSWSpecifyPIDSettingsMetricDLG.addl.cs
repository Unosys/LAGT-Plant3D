...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PSWSpecifyPIDSettingsMetricDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = AcMainWin.cBabel(23070, 3, "Project Setup Wizard(Page 3 of 6)");
		}
		...
		public override void Invoke()
		{
			...
			ProjectSetupWizardSpecifyUnitSettingsDLG.Invoke();
			ProjectSetupWizardSpecifyUnitSettingsDLG.M_metricRadioBtn.Click();
