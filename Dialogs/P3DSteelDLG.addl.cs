...
{
    public partial class P3DSteelDLG : Pane
    {
		...
		public  void Invoke()
		{
			...
			ProjectSetupProjectDetailsDLG.M_treeView.Expand(AcMainWin.cBabel(21047,1,"Plant 3D DWG Settings")+"/"+AcMainWin.cBabel(21051,1,"Plant 3D Class Definitions")+"/"+AcMainWin.cBabel(23073,18,"Steel Structure"));
			ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(21047,1,"Plant 3D DWG Settings")+"/"+AcMainWin.cBabel(21051,1,"Plant 3D Class Definitions")+"/"+AcMainWin.cBabel(23073,18,"Steel Structure"));
		}
