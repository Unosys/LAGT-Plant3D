...
{
    public partial class PandIDClassDefinitionOrSymbolNameRequiredDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[Pane]$SymbolSettingErrorMessageDlg";
		}

		public override void Invoke()
		{
			PandIDAddSymbolsSelectSymbolsDLG PandIDAddSymbolsSelectSymbolsDLG = new PandIDAddSymbolsSelectSymbolsDLG();
			PandIDAddSymbolsSelectSymbolsDLG.Invoke();
			...
			PandIDAddSymbolsEditSymbolSettingsDLG.SetActive();
