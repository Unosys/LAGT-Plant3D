...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class PandIDTagFormatSetupDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public PandIDTagFormatSetupDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[Pane]$panel1|#1/[Pane]Unique|$fieldsUserControl|#1/[PushButton]$m_btnClass",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[Pane]$panel1|#1/[Pane]Unique|$fieldsUserControl|#1/[PushButton]$m_btnDraw",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[Pane]$panel1|#1/[Pane]$fieldsUserControl|#1/[PushButton]$m_btnExpression|#4",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[Pane]$panel1|#1/[Pane]Unique|$fieldsUserControl|#1/[PushButton]$m_btnProject",
                ParentType = this.GetType(),
                Parent = this
            };
