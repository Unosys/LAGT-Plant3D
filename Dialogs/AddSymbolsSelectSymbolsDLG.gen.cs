...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]$SelectSymbolDlg", Parent = typeof(ProjectSetupPandIDClassDefinitionDLG))]
    public partial class AddSymbolsSelectSymbolsDLG : Pane
    {
        ...
        public AddSymbolsSelectSymbolsDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
