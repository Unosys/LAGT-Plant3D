...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select File", Parent = typeof(MainWin))]
    public partial class PandIDSelectFilePIDDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
