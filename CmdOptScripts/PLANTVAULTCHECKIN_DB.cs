...
{
	public class PLANTVAULTCHECKIN_DBCLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTVAULTCHECKIN_DB = new List<Command>
		{
			new PLANTVAULTCHECKIN_DB()
		};
	}

	public class PLANTVAULTCHECKIN_DB : Command
	{
		public override void Launch()
		{
			...
			CmdOpt_Engine.SendCmd("PLANTVAULTCHECKIN");
