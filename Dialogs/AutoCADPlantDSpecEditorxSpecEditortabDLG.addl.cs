...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AutoCADPlantDSpecEditorxSpecEditortabDLG : SpecEditorDLG
    {
		...
		public override void Invoke()
		{
			...
			var AutoCADPlantDSpecEditorxSpecEditortabDLG = new AutoCADPlantDSpecEditorxSpecEditortabDLG();
			AutoCADPlantDSpecEditorxSpecEditortabDLG.SetActive();
		}
