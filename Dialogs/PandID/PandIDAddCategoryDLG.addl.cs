...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDAddCategoryDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PandIDProjectSetupProjectDetailsDLG.M_btnAdd.Click();
		}

		public override void Dismiss()
		{
			PandIDAddCategoryDLG PandIDAddCategoryDLG = Current<PandIDAddCategoryDLG>();
            PandIDAddCategoryDLG.M_btnCancel.Click();
			PandIDProjectSetupProjectDetailsDLG PandIDProjectSetupProjectDetailsDLG = new PandIDProjectSetupProjectDetailsDLG();
