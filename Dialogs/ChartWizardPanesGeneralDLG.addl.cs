...
{
    public partial class ChartWizardPanesGeneralDLG : Pane
    {
		...
		public  void Invoke()
		{
			...
			Plant3DFunctions.ChartWizardPresentation(6);
			ChartWizardPanesGeneralDLG ChartWizardPanesGeneralDLG = new ChartWizardPanesGeneralDLG();
			ChartWizardPanesGeneralDLG.SetActive();
		}
		...
		public  void Dismiss()
		{
			ChartWizardPanesGeneralDLG ChartWizardPanesGeneralDLG = new ChartWizardPanesGeneralDLG();
			ChartWizardPanesGeneralDLG.SetActive();
			ChartWizardPanesGeneralDLG.TypeKeys("<Alt-F4>");
