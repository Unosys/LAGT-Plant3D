...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Excel Files to Build Catalog From|#1", Parent = typeof(AutoCADPlant3DCatalogBuilderApplicationDLG), GUIType = GuiType.UIA)]
    public partial class SelectExcelFilesToBuildCalogAppicationDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectExcelFilesToBuildCalogAppicationDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
