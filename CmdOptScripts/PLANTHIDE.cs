...
{
	public class PLANTHIDECLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTHIDE = new List<Command>
		{
			new PLANTHIDE()
		};
	}

	public class PLANTHIDE : Command
	{
		public override void Launch()
		{
			...
			CmdOpt_Engine.SendCmd("PLANTHIDE");
		}
		...
		public override void Verify()
		{
			...
			{
				CmdOpt_ErrorReport.tError sError = new CmdOpt_ErrorReport.tError("CMD_NOT_WORKING", "1 object should have been hided'.", "", "", "");
