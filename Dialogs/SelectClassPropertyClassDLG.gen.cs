...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]$SelectClassPropertyDlg", Parent = typeof(Plant3D))]
    public partial class SelectClassPropertyClassDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectClassPropertyClassDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
