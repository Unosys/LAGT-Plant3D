...
{
    public partial class ChartWizardAxesGeneralDLG : Pane
    {
		...
		public  void Dismiss()
		{
			ChartWizardAxesGeneralDLG ChartWizardAxesGeneralDLG = new ChartWizardAxesGeneralDLG();
			ChartWizardAxesGeneralDLG.SetActive();
			ChartWizardAxesGeneralDLG.TypeKeys("<Alt-F4>");
