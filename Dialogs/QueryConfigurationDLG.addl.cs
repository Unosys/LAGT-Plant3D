...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class QueryConfigurationDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			//Tag = "$QueryDefinitionForm";
            Tag = "[Pane]Query Configuration|$QueryDefinitionForm|#1";
		}
		...
		public override void Invoke()
		{
			...
			this.SetActive();
            this.MaximizePB.Click();
            this.ShowFilterExamplesPB.Click();
		}
		...
		public override void Dismiss()
		{
            ...
            QueryConfigurationDLG.ClosePB.Click();
