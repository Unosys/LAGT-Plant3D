...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectPostShapeDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "*" + AcMainWin.cBabel(23018, 1, "Post Shape") + "*";
		}
		...
		public override void Invoke()
		{
			...
			RailingSettingsDLG.PushButton4.Click();
		}

		public override void Dismiss()
		{
			SelectPostShapeDLG SelectPostShapeDLG = new SelectPostShapeDLG();
			SelectPostShapeDLG.Cancel.Click();
			RailingSettingsDLG RailingSettingsDLG = new RailingSettingsDLG();
