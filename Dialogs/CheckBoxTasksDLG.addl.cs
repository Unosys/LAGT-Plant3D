...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class CheckBoxTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(3);
            System.Threading.Thread.Sleep(4000);
            Desktop Desktop = new Desktop();
            //Plant3DFunctions.StandardControls(4);//Double Click 'Rich Text' in the 'Tool Box'
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\CheckBox.bmp");
			...
			CheckBoxTasksDLG CheckBoxTasksDLG = new CheckBoxTasksDLG();
			CheckBoxTasksDLG.SetActive();
		}
