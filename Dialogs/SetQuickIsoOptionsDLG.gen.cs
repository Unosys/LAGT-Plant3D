...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]Advanced Iso Creation Options|$QuickIsoOptions|#1", Parent = typeof(CreateQuickIsoDLG), GUIType = GuiType.UIA)]
    public partial class SetQuickIsoOptionsDLG : Pane
    {
        public  GroupBox OverrideLocationGB;
        public  StaticText DEGST;
        public  StaticText YST;
        public  TextField YTF;
        public  StaticText XST;
        public  StaticText OffsetRotationST;
        public  StaticText OffsetLocationST;
        public  TextField OffsetRotationTF;
        ...
        public  CheckBox CheckBox_CreateSplitAutomatically;
        ...
        public  PopupList ExportTablesOnIsoPL;
        public  PushButton DropDownButton2PB;
        public  StaticText ExportFormatST;
        ...
        private void InitializeComponent()
        {
            ...
            OverrideLocationGB = new GroupBox()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(OverrideLocationGB);

            DEGST = new StaticText()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[StaticText]DEG*|$label_Deg|#5",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            YST = new StaticText()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[StaticText]Y:|$label_Y|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            YTF = new TextField()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[TextField]Y:|$textBox_Y|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            XST = new StaticText()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[StaticText]X:|$label_X|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(XST);

            OffsetRotationST = new StaticText()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[StaticText]Offset rotation:|$label_OffsetRotation|#4",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(OffsetRotationST);

            OffsetLocationST = new StaticText()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[StaticText]Offset location:|$label_OffsetLocation|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(OffsetLocationST);

            OffsetRotationTF = new TextField()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[TextField]Offset rotation:|$textBox_Deg|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(OffsetRotationTF);

            XTF = new TextField()
            {
                Tag = "[GroupBox]Override location|$groupBox_OverrideLocation|#5/[TextField]X:|$textBox_X|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            CheckBox_CreateSplitAutomatically = new CheckBox()
            {
            ...
            DeclaredChildren.Add(CheckBox_CreateSplitAutomatically);
            ...
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[CheckBox]Spool|$checkBox_ExportSpool|#4",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            WeldCK = new CheckBox()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[CheckBox]Weld|$checkBox_ExportWeld|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[CheckBox]Cut Piece|$checkBox_ExportCutPiece|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            BOMCK = new CheckBox()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[CheckBox]BOM|$checkBox_ExportBOM|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(BOMCK);

            ExportTablesOnIsoPL = new PopupList()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[PopupList]Export tables on Iso creation:|$comboBox_ExportFormat|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(ExportTablesOnIsoPL);

            DropDownButton2PB = new PushButton()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[PopupList]Export tables on Iso creation:|$comboBox_ExportFormat|#1/[PushButton]Drop Down Button|$DropDown|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(DropDownButton2PB);

            ExportFormatST = new StaticText()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[StaticText]Export format:|$label2|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(ExportFormatST);

            ExportTablesOnIsoST = new StaticText()
            {
                Tag = "[GroupBox]Export settings|$groupBox_ExportSettings|#2/[StaticText]Export tables on Iso creation:|$label1|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            Button_OK = new PushButton()
            {
                Tag = "[PushButton]OK|$button_OK|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(Button_OK);
