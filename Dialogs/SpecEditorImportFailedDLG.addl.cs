...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SpecEditorImportFailedDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			SpecUtilityImportFromDLG.TypeKeys(LAGT.CommonFiles.Product.Variables.TestFilesDir+"test.xls");
		...
		{
			SpecEditorImportFailedDLG SpecEditorImportFailedDLG = new SpecEditorImportFailedDLG();
			SpecEditorImportFailedDLG.SetActive();
			SpecEditorImportFailedDLG.OKPB.Click();
