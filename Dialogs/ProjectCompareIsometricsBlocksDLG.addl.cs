    ...
    public partial class ProjectCompareIsometricsBlocksDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            switch (LAGT.CommonFiles.Product.Variables.Language.ToUpper())
            {
                ...
                case "RUS":
                case "KOR":
                    this.TreeViewTV.Select(AcMainWin.cBabel(23069, 12, "Isometrics"));
                    Desktop.Current.TypeKeys("<Down>");
                    break;
                default:
                    this.TreeViewTV.Select(AcMainWin.cBabel(23069, 6, "Blocks"));
                    break;

            }
            this.AnnoCCircleLBI.Click(MouseButton.Left, 1, 1);
            this.Size(1200, 690);
        }
