...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDProjectSetupProjectReportsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            PandIDFunctions.treeViewExpand(PandIDProjectSetupEndConnectionDLG.M_treeView, AcMainWin.cBabel(21016, 1, "Reports"));
            PandIDFunctions.treeViewSelect(PandIDProjectSetupEndConnectionDLG.M_treeView, AcMainWin.cBabel(21016, 1, "Reports"));
            PandIDProjectSetupProjectDetailsDLG.ReportsTVI.Click();
