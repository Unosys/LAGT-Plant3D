...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Script File|#1", Parent = typeof(AutoCADPlant3DCatalogBuilderApplicationDLG), GUIType = GuiType.UIA)]
    public partial class Plant3DCatalogBuilderSelectScriptFileDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public Plant3DCatalogBuilderSelectScriptFileDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[TitleBar]Select Script File|$TitleBar|#1/[PushButton]Close|$Close|#1",
                ParentType = this.GetType(),
                Parent = this
            };
