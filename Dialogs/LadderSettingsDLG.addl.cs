...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class LadderSettingsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23014, 1, "Ladder Settings")+"|*"+AcMainWin.cBabel(23068, 2, "Settings")+"*";
		}
		...
		{
			LadderSettingsDLG LadderSettingsDLG = new LadderSettingsDLG();
			LadderSettingsDLG.Cancel.Click();
