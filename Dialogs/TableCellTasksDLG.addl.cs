...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class TableCellTasksDLG : Pane
    {
		...
		{
            Tag = "Table Cell|#1"; // "DevExpress.XtraReports.Design.XRSmartTagService+PopupForm";
		}
		...
		public  void Invoke()
		{
			...
			//Plant3DFunctions.StandardControls(7);
			
            System.Threading.Thread.Sleep(4000);
            Desktop Desktop = new Desktop();
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Table.bmp");
            Desktop.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
            System.Threading.Thread.Sleep(4000);
           
			Desktop.TypeKeys("<Tab 2>");
			System.Threading.Thread.Sleep(4000);
			...
			TableCellTasksDLG TableCellTasksDLG = new TableCellTasksDLG();
			TableCellTasksDLG.SetActive();
		}
