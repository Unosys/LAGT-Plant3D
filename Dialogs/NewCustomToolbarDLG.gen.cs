...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]New Toolbar|#2", Parent = typeof(CustomizationDLG), GUIType = GuiType.UIA)]
    public partial class NewCustomToolbarDLG : Pane
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[Pane]$pnlNBDlg/[TextField]Toolbar Name:|$tbNBDlgName/[TextField]$1508832",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[TitleBar]New Toolbar|$TitleBar",
                ParentType = this.GetType(),
                Parent = this
            };
