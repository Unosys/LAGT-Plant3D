...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class CreateContentPackDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23071, 8, "Create Content Pack")+"|#1";
		}
		...
		public override void Invoke()
		{
			...
			BuildCatalogSingleDLG.ContentPackPB.Click();
			CreateContentPackDLG CreateContentPackDLG = new CreateContentPackDLG();
			CreateContentPackDLG.SetActive();
		}
		...
		public override void Dismiss()
		{
			CreateContentPackDLG CreateContentPackDLG = new CreateContentPackDLG();
			CreateContentPackDLG.SetActive();
			CreateContentPackDLG.Cancel.Click();
			BuildCatalogSingleDLG BuildCatalogSingleDLG = new BuildCatalogSingleDLG();
