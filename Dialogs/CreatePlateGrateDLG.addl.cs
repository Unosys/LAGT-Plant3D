...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class CreatePlateGrateDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23011, 3, "Create Plate*Grate");
		}
		...
		public override void Invoke()
		{
			...
			Drawing.Current.TypeE("_PlantSteelPlate");
		}

		public override void Dismiss()
		{
			CreatePlateGrateDLG CreatePlateGrateDLG = new CreatePlateGrateDLG();
			CreatePlateGrateDLG.Cancel.Click();
