...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupWizardVault1DLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			ProjectSetupWizardVault1DLG ProjectSetupWizardVault1DLG = Current<ProjectSetupWizardVault1DLG>();
			ProjectSetupWizardVault1DLG.SetActive();
		}

		public override void Dismiss()
		{
			ProjectSetupWizardVault1DLG ProjectSetupWizardVault1DLG = Current<ProjectSetupWizardVault1DLG>();
			ProjectSetupWizardVault1DLG.M_buttonCancel.Click();
