...
{
    public partial class PandIDSQLServerSignInDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Dismiss()
		{
			...
			PandIDSQLServerSignInDLG.SetActive();
			PandIDSQLServerSignInDLG.CancelPB.Click();
