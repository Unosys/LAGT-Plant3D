...
{
    public partial class FilterStringEditorDLG : Pane
    {
		...
		{
            Tag = "[Pane]$ReportFilterStringEditorForm";
        ...
        public void Invoke()
        {
            ...
            SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\StyleSheet\\FilterString.bmp");
            Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCenter, SAM.iBottom - 2);
        }
