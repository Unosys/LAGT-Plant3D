...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]$frmVaultAttachReferences", Parent = typeof(Plant3D), GUIType = GuiType.UIA)]
    public partial class AttachXRefFromVaultDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
