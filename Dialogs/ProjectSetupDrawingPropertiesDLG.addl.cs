...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupDrawingPropertiesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			ProjectSetupEndConnectionDLG.M_treeView.Select("*/" + AcMainWin.cBabel(21008, 1, "Drawing Properties"));
		}

		public override void Dismiss()
		{
			ProjectSetupDrawingPropertiesDLG ProjectSetupDrawingPropertiesDLG = new ProjectSetupDrawingPropertiesDLG();
			ProjectSetupDrawingPropertiesDLG.M_btnOk.Click();
