...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class TrimToPlaneDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23008, 1, "Trim to Plane");
		}
		...
		public override void Invoke()
		{
			...
			Drawing.Current.TypeE("_PlantSteelTrim");
		}

		public override void Dismiss()
		{
			TrimToPlaneDLG TrimToPlaneDLG = new TrimToPlaneDLG();
			TrimToPlaneDLG.Cancel.Click();
