...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Import From", Parent = typeof(CustomWin))]
    public partial class ImportFromDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
