...
{
    public partial class LogInDLG : Pane //Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public  void Invoke()
		{
            ...
            System.Threading.Thread.Sleep(2000);
            VaultLogInDLG VaultLogInDLG = Current<VaultLogInDLG>();
			VaultLogInDLG.SetActive();
		}

		public  void Dismiss()
		{
			this.CancelPANE.Click();
		}
    }
}
