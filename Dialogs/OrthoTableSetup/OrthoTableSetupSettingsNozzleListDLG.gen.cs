...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class OrthoTableSetupSettingsNozzleListDLG : Window
    {
        ...
        public OrthoTableSetupSettingsNozzleListDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[PageList]$TabControl_Table|#1/[Window]Settings|$TabItem_Settings|#2/[CustomWin]$UserControl_BOMSetupSetting|#1/[PushButton]Add|$Button_GroupByAdd|#1",
            ...
            {
                Tag = "[PageList]$TabControl_Table|#1/[Window]Settings|$TabItem_Settings|#2/[CustomWin]$UserControl_BOMSetupSetting|#1/[PushButton]$Button_SortByAdd",
                ParentType = this.GetType(),
                Parent = this
            };
