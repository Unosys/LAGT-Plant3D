...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectFilePIDDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "~ActiveApp/[DialogBox]" + AcMainWin.cBabel(200, 1, "Select File");
		}

		public override void Invoke()
		{
            Drawing.Current.TypeE ("_.filedia 1");
            ...
            SelectFileDLG SelectFileDLG = new SelectFileDLG();
            SelectFileDLG.SetActive();
        }
