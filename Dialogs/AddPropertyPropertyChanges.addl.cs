...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AddPropertyPropertyChanges : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            IsometricDWGSettingsAnnotationsPropertyChangesDLG.Invoke();

            IsometricDWGSettingsAnnotationsPropertyChangesDLG.PushButton8PB.Click();
		...
		public override void Dismiss()
		{
			this.CancelPB.Click();
            IsometricDWGSettingsAnnotationsPropertyChangesDLG IsometricDWGSettingsAnnotationsPropertyChangesDLG = new IsometricDWGSettingsAnnotationsPropertyChangesDLG();
            IsometricDWGSettingsAnnotationsPropertyChangesDLG.Dismiss();
        }
    }
}
