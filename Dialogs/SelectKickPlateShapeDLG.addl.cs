...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectKickPlateShapeDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "*" + AcMainWin.cBabel(23017, 1, "Kick Plate Shape") + "*";
		}
		...
		public override void Invoke()
		{
			...
			RailingSettingsDLG.PushButton3.Click();
		}

		public override void Dismiss()
		{
			SelectKickPlateShapeDLG SelectKickPlateShapeDLG = new SelectKickPlateShapeDLG();
			SelectKickPlateShapeDLG.Cancel.Click();
			RailingSettingsDLG RailingSettingsDLG = new RailingSettingsDLG();
