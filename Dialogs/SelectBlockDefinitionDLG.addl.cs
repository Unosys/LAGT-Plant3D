...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectBlockDefinitionDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        {
            Tag = "[Window]$SelectBlockDefinitionWindow";

        }

		public override void Invoke()
		{
            OpenDWGDLG OpenDWGDLG = new OpenDWGDLG();
            OpenDWGDLG.Invoke();
            OpenDWGDLG.FileNameCB.SetText(LAGT.CommonFiles.Product.Variables.TestFilesDir+ "cs18048077\\1804-8077.dwg");
            OpenDWGDLG.OpenPB.Click();
            this.SetActive();
