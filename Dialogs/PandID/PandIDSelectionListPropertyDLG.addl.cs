...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDSelectionListPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            PandIDAddPropertyDLG.M_textBoxPropertyName.SetText("TestList");
            PandIDAddPropertyDLG.M_radioSelection.Click();
            PandIDAddPropertyDLG.M_btnOk.Click();
        }

		public override void Dismiss()
		{
            this.Close();
            var PandIDAddPropertyDLG = new PandIDAddPropertyDLG();
