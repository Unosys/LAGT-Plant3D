...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
   ...
   //         SpecEditorDLG.ShowWelcomeScreen.Pick();
			//SpecUtilityWelcometoDLG SpecUtilityWelcometoDLG = new SpecUtilityWelcometoDLG();
			//SpecUtilityWelcometoDLG.SetActive();
		}
		...
		public override void Dismiss()
		{
			//SpecUtilityWelcometoDLG SpecUtilityWelcometoDLG = new SpecUtilityWelcometoDLG();
			//SpecUtilityWelcometoDLG.SetActive();
			//SpecUtilityWelcometoDLG.DoNotShowCheck.Check();
			//SpecUtilityWelcometoDLG.CloseButton.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
