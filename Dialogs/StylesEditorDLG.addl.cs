...
{
    public partial class StylesEditorDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            switch (LAGT.CommonFiles.Product.Variables.Language.ToUpper())
            {
                ...
                default:
                    ...
                    Desktop.Click(MouseButton.Left, SAM.iXCenter, SAM.iYCenter+8);
		...
		public  void Dismiss()
		{
            ...
            StylesEditorDLG.Close1PB.Click();
            ReportDesignerApplicationDLG ReportDesignerApplicationDLG = new ReportDesignerApplicationDLG();
