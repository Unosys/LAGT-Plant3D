...
{
    public partial class ProjectSetupPipeSpecObjectMappingDLG_Fittings : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            ProjectSetupPipeSpecObjectMappingDLG.Window3WIN.Click(MouseButton.Left, 2, 2);
            this.SetActive();
        }
