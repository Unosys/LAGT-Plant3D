...
{
    public partial class PIDObjectMappingNonEngineeringItemsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  void Invoke()
        {
            ...
            try
            {
                wtreeView.Select(AcMainWin.cBabel(21100, 12, "Non Engineering Items"));
            }
            catch
            {
