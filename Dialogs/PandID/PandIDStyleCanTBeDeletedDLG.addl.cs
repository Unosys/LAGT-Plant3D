...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDStyleCanTBeDeletedDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(21022, 1, "Style can't be deleted");
        }

		public override void Invoke()
		{
            //PandIDFunctions.InvokeCentrifugalBlower();
            ...
            {
                case "RUS":
                    PandIDProjectSetupProjectDetailsDLG.TreeViewTV.TypeKeys("<Down 5>");
                    break;
                case "JPN":
                    PandIDProjectSetupProjectDetailsDLG.TreeViewTV.TypeKeys("<Down>");
                    break;
                case "DEU":
                    PandIDProjectSetupProjectDetailsDLG.TreeViewTV.TypeKeys("<Down 4>");
                    break;
                default:
            ...
            PandIDProjectSetupPandIDClassDefinitionDLG.M_btnRemoveStyle.Click();
		}
