...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class EditLongDescriptionStyleDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  PushButton SaveAsPB;
        public  GroupBox LDFEditorGroupBox;
        public  PushButton PreviousButton;
        public  PushButton NextButton;
        public  StaticText LDSampleResult;
        public  StaticText LDSampleResultLabel;
        ...
        public EditLongDescriptionStyleDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            SaveAsPB = new PushButton()
            {
                Tag = "[PushButton]$SaveAsButton",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(SaveAsPB);
            ...
            {
                Tag = "[PushButton]$PreviousButton",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(PreviousButton);

            NextButton = new PushButton()
            {
                Tag = "[PushButton]$NextButton",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(NextButton);

            LDSampleResult = new StaticText()
            {
                Tag = "[StaticText]$LDSampleResult",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(LDSampleResult);

            LDSampleResultLabel = new StaticText()
            {
                Tag = "[StaticText]$LDSampleResultLabel",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(LDSampleResultLabel);
