...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectCompareIsometricsIsoStylesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            this.TreeViewTV.Select(AcMainWin.cBabel(23069, 5, "Iso Styles"));
            this.CheckANSIBLBI.Click(MouseButton.Left, 1, 1);
            this.IsoConfigxmlLBI.Click(MouseButton.Left, 1, 1);
