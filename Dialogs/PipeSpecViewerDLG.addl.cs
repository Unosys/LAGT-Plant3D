...
{
    public partial class PipeSpecViewerDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox//CustomWin
    {
		...
		{
            Tag = "[CustomWin]#3|#5|*PIPE SPEC VIEWER";
        ...
        public override void Invoke()
		{
            ...
            PipeSpecViewerDLG PipeSpecViewerDLG = new PipeSpecViewerDLG();
            //PipeSpecViewerDLG.SetActive();
              //this.SetSize(660,530);
            System.Threading.Thread.Sleep(5000);
            this.Row1LVI.Click();
            System.Threading.Thread.Sleep(1000);
            this.TypeKeys("<Down 2>");
        }
        ...
        //    Desktop.Current.Click(MouseButton.Left, rSize.xPos + 5, rSize.yPos + 50);
        //}
