...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDDatabaseNamePrefixErrorDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[DialogBox]" + AcMainWin.cBabel(21100, 8, "Database Name Prefix Test");
		}
		...
		public override void Invoke()
		{
            ...
            PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.M_comboServer.TypeKeys(sPCName);
			PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.M_tbDbName.TypeKeys("=*");
		...
		public override void Dismiss()
		{
			this.OK.Click();
			PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG = new PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG();
			PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.Dismiss();
