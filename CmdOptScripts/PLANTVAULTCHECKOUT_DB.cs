...
{
	public class PLANTVAULTCHECKOUT_DBCLASS
	{
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTVAULTCHECKOUT_DB = new List<Command>
		{
			new PLANTVAULTCHECKOUT_DB()
		};
	}

	public class PLANTVAULTCHECKOUT_DB : Command
	{
