...
{
    public partial class ShapeTasksDLG : Pane
    {
		...
		{
            Tag = "Shape|#1"; // "DevExpress.XtraReports.Design.XRSmartTagService+PopupForm";
		}
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(9);
            Desktop Desktop = new Desktop();
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Shape.bmp");
			...
			ShapeTasksDLG ShapeTasksDLG = new ShapeTasksDLG();
			ShapeTasksDLG.SetActive();
