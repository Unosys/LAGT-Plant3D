...
{
    public partial class PandIDImportFromDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "[DialogBox]" + AcMainWin.cBabel(21031,1,"Import From");
		}

        public override void Invoke()
        {
            PandIDAutoCADPIDDLG PandIDAutoCADPIDDLG = new PandIDAutoCADPIDDLG();
            PandIDAutoCADPIDDLG.Invoke();
            PandIDAutoCADPIDDLG.Close();
        }
