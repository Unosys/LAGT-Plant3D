...
{
    public partial class ProjectSetupSQLAuthDatabaseSetupDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            ProjectSetupWizardSpecifyDatabaseSettingsDLG.M_comboServer.SetText ("{sPCName}");
			ProjectSetupWizardSpecifyDatabaseSettingsDLG.M_comboAuthent.Select(AcMainWin.cBabel(23042,5,"SQL Server Authentication"));
			ProjectSetupWizardSpecifyDatabaseSettingsDLG.M_tbUsrName.SetText("sa");
			ProjectSetupWizardSpecifyDatabaseSettingsDLG.M_tbPwd.SetText("saPass");
