...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]$SelectProjectAutogenDlg", Parent = typeof(Plant3D))]
    public partial class SelectProjectAutogenerationPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectProjectAutogenerationPropertyDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
