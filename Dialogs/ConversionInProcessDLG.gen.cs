...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Sharing Project to the Cloud", Parent = typeof(PlantProjectCollaborationUploadingProcessDLG), GUIType = GuiType.UIA)]
