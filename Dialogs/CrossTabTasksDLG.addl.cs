...
{
    public partial class CrossTabTasksDLG : Pane
    {
        ...
        public void Invoke()
		{
            ...
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\CrossTab.bmp");
