...
{
	public class PLANTEDITALLNOZZLESCLASS
    {
		public string FeatureType = "Command";
		public string releaseVer = "2016";
		public List<Command> lcPLANTEDITALLNOZZLES = new List<Command>
		{
			new PLANTEDITALLNOZZLES(),
			new PLANTEDITALLNOZZLES_OFF(),
			new PLANTEDITALLNOZZLES_ON()
		};
	}

	public class PLANTEDITALLNOZZLES : Command
	{
		public override void Launch()
		{
			
            CmdOpt_Engine.SendCmd("PLANTEDITALLNOZZLES");
        }
	...
	public class PLANTEDITALLNOZZLES_OFF : PLANTEDITALLNOZZLES
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTEDITALLNOZZLES");
	...
	public class PLANTEDITALLNOZZLES_ON : PLANTEDITALLNOZZLES
    {
		public override void Launch()
		{
			CmdOpt_Engine.SendCmd("PLANTEDITALLNOZZLES");
