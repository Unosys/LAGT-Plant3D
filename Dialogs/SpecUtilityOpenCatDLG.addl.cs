...
{
    public partial class SpecUtilityOpenCatDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            //SpecEditorDLG.CatalogPL.Select(0);
            //SpecEditorDLG.TypeKeys("<End><Enter>");
		...
		public override void Dismiss()
		{
			SpecUtilityOpenCatDLG SpecUtilityOpenCatDLG = new SpecUtilityOpenCatDLG();
			SpecUtilityOpenCatDLG.SetActive();
			SpecUtilityOpenCatDLG.Cancel.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
			SpecEditorDLG.SetActive();
