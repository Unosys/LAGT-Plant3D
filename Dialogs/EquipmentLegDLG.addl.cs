...
{
    public partial class EquipmentLegDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public void Invoke()
        {
            ...
            P3DCreateEquipmentDLG.TypeKeys("<Down 8><Enter>");   //Cylinder
            P3DCreateEquipmentDLG.AddTrimPB.Click();
            P3DCreateEquipmentDLG.TypeKeys("<Down 6><Enter>");  // Leg
        }
        public void Dismiss()
        {
            P3DCreateEquipmentDLG P3DCreateEquipmentDLG = new P3DCreateEquipmentDLG();
