...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]$SelectProjectPropertyDlg", Parent = typeof(Plant3D))]
    public partial class SelectProjectPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectProjectPropertyDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
