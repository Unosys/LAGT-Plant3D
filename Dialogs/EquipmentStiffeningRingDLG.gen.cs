...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[Pane]Create Equipment|$EquBaseDlg|#1", Parent = typeof(Plant3D), GUIType = GuiType.UIA)]
    public partial class EquipmentStiffeningRingDLG : Pane
    {
        ...
        public EquipmentStiffeningRingDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
