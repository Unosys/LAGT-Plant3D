...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Template File", Parent = typeof(IsometricDWGSettingsTitleBlockandDisplayDLG))]
    public partial class SelectIsometricDrawingTemplateFileDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  GroupBox Preview;
        public  PushButton PreviewPushButton;
        ...
        public SelectIsometricDrawingTemplateFileDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            PreviewPushButton = new PushButton()
            {
                Tag = "[PushButton]$Preview",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(PreviewPushButton);
