...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SeriesCollectionEditorPointsDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //ChartWizardChartDLG.OKPB.Click();  // need to be checked manually with addlspy
			...
			{
				case "DEU":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\DEU_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                case "JPN":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\JPN_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                case "FRA":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\FRA_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                case "KOR":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\KOR_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                case "RUS":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\RUS_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                case "CHS":
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\CHS_Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
                default:
                    SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\ChartTasks\\Series.bmp");
                    Desktop.Current.DoubleClick(MouseButton.Left, SAM.iXCoord + 5, SAM.iYCoord + 5);
                    break;
		...
		public  void Dismiss()
		{
			...
			SeriesCollectionEditorPointsDLG.TypeKeys("<Alt-F4>");
        ...
        {
            SeriesCollectionEditorPointsDLG SeriesCollectionEditorPointsDLG = new SeriesCollectionEditorPointsDLG();
            RECT r=SeriesCollectionEditorPointsDLG.PointsPANE.GetRect (true);
