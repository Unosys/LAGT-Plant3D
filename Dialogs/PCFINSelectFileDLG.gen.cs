...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select File", Parent = typeof(MainWin), GUIType = GuiType.WIN32)]
    public partial class PCFINSelectFileDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[PushButton]Delete (Del)|$13014|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[PushButton]Create New Folder (Alt+5)|$13013|#4",
                ParentType = this.GetType(),
                Parent = this
            };
