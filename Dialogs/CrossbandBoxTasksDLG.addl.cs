...
{
    public partial class CrossbandBoxTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(17);
			...
			ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\CrossbanBox.bmp");
		...
		{
            ReportDesignerApplicationDLG ReportDesignerApplicationDLG = new ReportDesignerApplicationDLG();
            var ReportLayoutModifiedSaveChangesDLG = new ReportLayoutModifiedSaveChangesDLG();
            var ReportConfigurationDLG = new ReportConfigurationDLG();
