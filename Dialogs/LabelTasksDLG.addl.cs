...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class LabelTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(2);//Click 'Label' in the 'Tool Box'
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Label.bmp");
		...
		public  void Dismiss()
		{
			...
			ReportDesignerApplicationDLG.TypeKeys("<Esc>");
