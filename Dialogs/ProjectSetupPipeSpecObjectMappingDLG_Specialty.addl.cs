...
{
    public partial class ProjectSetupPipeSpecObjectMappingDLG_Specialty : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            ProjectSetupPipeSpecObjectMappingDLG.Window4WIN.Click(MouseButton.Left, 2, 2);
            this.SetActive();
        }
