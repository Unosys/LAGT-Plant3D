...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupIsometricDWGSettingsDLG : Pane
    {
		...
		{
            Tag = "Project Setup*|$EditProjectSettingsDlg";
		}
		...
		public void Invoke()
		{
            ...
            ProjectSetupProjectDetailsDLG.IsometricDWGSettingsTVI.Click();
            System.Threading.Thread.Sleep(1000);
            ProjectSetupProjectDetailsDLG.IsometricDWGSettingsTVI.TypeKeys("<Add>");
            //ProjectSetupProjectDetailsDLG.IsometricDWGSettingsTVI.Expand(AcMainWin.cBabel(23035, 5, "Isometric DWG Settings"));
