...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ReminderLongDescriptionfilledwithcorrectvalueDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            //SpecUtilitySaveChangesDLG SpecUtilitySaveChangesDLG = new SpecUtilitySaveChangesDLG();
            //         SpecUtilitySaveChangesDLG.Invoke();		
            //SpecUtilitySaveChangesDLG.Image2IMG.Click(MouseButton.Left,2,2);
            //if (SpecUtilitySaveChangesDLG.Image2IMG.Exists) {
            //	SpecUtilitySaveChangesDLG.Image2IMG.DoubleClick();
            //}
            ...
            AutoCADPlantDSpecEditorxCatalogEditortabDLG.SaveToCatalogPB.Click();
            this.SetActive();
        }
