...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDReplacePandIDDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PandIDNewReportCopyOfControlValveListDLG.Invoke();
			System.Threading.Thread.Sleep(5000);
			PandIDNewReportCopyOfControlValveListDLG.M_btnReplaceTable.Click();
		}
		...
		public override void Dismiss()
		{
			...
			PandIDNewReportCopyOfControlValveListDLG PandIDNewReportCopyOfControlValveListDLG = new PandIDNewReportCopyOfControlValveListDLG();
			PandIDNewReportCopyOfControlValveListDLG.Dismiss();
		}
    }
}
