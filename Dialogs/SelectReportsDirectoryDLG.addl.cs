...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectReportsDirectoryDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "~ActiveApp/[DialogBox]" + AcMainWin.cBabel(21035,1,"Select Reports Directory");
		}
		...
		public override void Invoke()
		{
            ...
            ProjectSetupProjectDetailsDLG.PushButton2PB.Click();
		}

		public override void Dismiss()
		{
			SelectReportsDirectoryDLG SelectReportsDirectoryDLG = new SelectReportsDirectoryDLG();
			SelectReportsDirectoryDLG.Cancel.Click();
			ProjectSetupProjectDetailsDLG ProjectSetupProjectDetailsDLG = new ProjectSetupProjectDetailsDLG();
