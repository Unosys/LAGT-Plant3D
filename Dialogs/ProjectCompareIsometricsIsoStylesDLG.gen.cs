...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class ProjectCompareIsometricsIsoStylesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  StaticText IsoStyles1ST;
        ...
        public  StaticText IsoStyles2ST;
        ...
        public ProjectCompareIsometricsIsoStylesDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            IsoStyles2ST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[StaticText]Iso Styles|$TextBlock_1|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IsoStyles2ST);
            ...
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]#1/[ListBoxItem]#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#1/[StaticText]Check_ANSI-B|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource2LBI);

            CheckANSICST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#2/[StaticText]Check_ANSI-C|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CheckANSICST);

            AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource3LBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource3LBI);

            FinalANSIBST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#3/[StaticText]Final_ANSI-B|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(FinalANSIBST);

            AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource4LBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#4",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource4LBI);

            FinalANSICST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#4/[StaticText]Final_ANSI-C|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(FinalANSICST);

            AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource5LBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#5",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource5LBI);

            SpoolANSIBST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#5/[StaticText]Spool_ANSI-B|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(SpoolANSIBST);

            AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource6LBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#6",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(AutodeskProcessPowerProjectManagerUIProjectCompareConflictSource6LBI);

            StressANSICST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#2/[GroupBox]Modified|#1/[ListBoxItem]Autodesk*|#6/[StaticText]Stress_ANSI-C|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(StressANSICST);
            ...
            CheckANSIBFilesST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[StaticText]Check_ANSI-B  Files|$TextBlock_9|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CheckANSIBFilesST);

            CheckANSIBFilesLB = new ListBox()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]Check_ANSI-B  Files|$FilesListView|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(CheckANSIBFilesLB);

            IsodwtLBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$FilesListView|#1/[ListBoxItem]#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IsodwtLBI);

            IsodwtST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]Check_ANSI-B  Files|$FilesListView|#1/[ListBoxItem]Autodesk*|#1/[StaticText]Iso*|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IsodwtST);

            IsoConfigxmlLBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$FilesListView|#1/[ListBoxItem]#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IsoConfigxmlLBI);

            IsoConfigxmlST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]Check_ANSI-B  Files|$FilesListView|#1/[ListBoxItem]Autodesk*|#2/[StaticText]IsoConfig*|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IsoConfigxmlST);

            StaticTextST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[StaticText]$TextBlock_5|#3",
                ParentType = this.GetType(),
                Parent = this
            };
