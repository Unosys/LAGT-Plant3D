...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ConfirmDeleteSelectionListDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        {
            Tag = AcMainWin.cBabel(426, 34, "Confirm Delete") + "|*" + AcMainWin.cBabel(23062, 7, "Confirm ") + "*" + "|*" + AcMainWin.cBabel(14, 17, "Delete ").Replace("* ", "*") + "*";
        ...
        public override void Invoke()
		{
            ...
            Plant3DDeleteSharedListDLG.Invoke();
            Plant3DDeleteSharedListDLG.StopSharingTETSPB.Click();
