...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Autodesk Vault Stand Alone Client", Parent = typeof(MainWin), GUIType = GuiType.WIN32)]
    public partial class LaunchingAutodeskVaultProfessionalWarningDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public LaunchingAutodeskVaultProfessionalWarningDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[Pane]Autodesk Vault Stand Alone Client|$Window|#1/[PushButton]Launch Autodesk Vault|$CommandLink_1001|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[Pane]Autodesk Vault Stand Alone Client|$Window|#1/[PushButton]Do Not Launch Autodesk Vault|$CommandLink_2|#2",
                ParentType = this.GetType(),
                Parent = this
            };
