...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectHandrailShapeDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "*" + AcMainWin.cBabel(23015, 1, "Handrail Shape") + "*";
		}
		...
		public override void Invoke()
		{
			...
			RailingSettingsDLG.PushButton.Click();
		}

		public override void Dismiss()
		{
			SelectHandrailShapeDLG SelectHandrailShapeDLG = new SelectHandrailShapeDLG();
			SelectHandrailShapeDLG.Cancel.Click();
			RailingSettingsDLG RailingSettingsDLG = new RailingSettingsDLG();
