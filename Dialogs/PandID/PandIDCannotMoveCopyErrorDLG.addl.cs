...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDCannotMoveCopyErrorDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			string sProjectPath1 = new Plant3DMainWin().RoamableRootFolder+"SampleProjects\\SampleProject\\Project.xml";
			PandIDProjectMaintenanceUtilityDLG PandIDProjectMaintenanceUtilityDLG = new PandIDProjectMaintenanceUtilityDLG();
			PandIDProjectMaintenanceUtilityDLG.Invoke();
			PandIDProjectMaintenanceUtilityDLG.CopyRBtn.Click();
			PandIDProjectMaintenanceUtilityDLG.NextBtn.Click();
			...
			PandIDOpenReportCreatorProjectDLG.FileNameCB.SetText(sProjectPath1);
			PandIDOpenReportCreatorProjectDLG.OpenPB.Click();
		}

		public override void Dismiss()
		{
			PandIDCannotMoveCopyErrorDLG PandIDCannotMoveCopyErrorDLG = Current<PandIDCannotMoveCopyErrorDLG>();
			PandIDCannotMoveCopyErrorDLG.SetActive();
			PandIDCannotMoveCopyErrorDLG.OK.Click();
