...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Project Setup Wizard (Page 5 of 6)", Parent = typeof(Pane), GUIType = GuiType.UIA)]
    public partial class ProjectSetupWizardPage5MSG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public ProjectSetupWizardPage5MSG()
        {
            InitializeComponent();
            OnInitialize();
        }
