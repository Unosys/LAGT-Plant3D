...
{
    public partial class Plant3DOrthoGenerationDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        {
            Tag = "[MainWin]$Window_1";//Plant 3D - Ortho Generation|
        }
        public override void Invoke()
        {
            ...
            ViewisUptoDateDLG.SetActive();

        }
        public override void Dismiss()
        {
            ViewisUptoDateDLG ViewisUptoDateDLG = new ViewisUptoDateDLG();
            ViewisUptoDateDLG.Dismiss();
        }
