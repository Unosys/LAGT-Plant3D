...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Specs and Catalogs", Parent = typeof(ConvertAutoPLANTSpecsAndCatalogsDLG), GUIType = GuiType.UIA)]
    public partial class SelectSpecsandCatalogsDLG2 : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectSpecsandCatalogsDLG2()
        {
            InitializeComponent();
            OnInitialize();
        }
