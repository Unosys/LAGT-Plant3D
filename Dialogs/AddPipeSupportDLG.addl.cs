...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AddPipeSupportDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[Window]$ShapeBrowserWindow|" + AcMainWin.cBabel(23060, 1, "Add Pipe Support") + "";
		}
		...
		public override void Invoke()
		{
            ...
            Drawing.Current.TypeE("_PLANTPIPEADD");//copyclip
            System.Threading.Thread.Sleep(2000);
            //Drawing.Current.TypeKeys("<Esc>");
            ////Drawing.Current.TypeE("_copyclip");
            Drawing.Current.TypeE("1250,800");
            Drawing.Current.TypeE("1650,800");
            System.Threading.Thread.Sleep(2000);
            AddPipePopupDLG AddPipePopupDLG = new AddPipePopupDLG();
            if (AddPipePopupDLG.Exists) {
                AddPipePopupDLG.CheckBX.Check();
                AddPipePopupDLG.ClosePB.Click();
            ...
            Drawing.Current.TypeE("_PLANTPIPESUPPORTADD");
            System.Threading.Thread.Sleep(20000);
            AddPipeSupportDLG AddPipeSupportDLG = new AddPipeSupportDLG();
