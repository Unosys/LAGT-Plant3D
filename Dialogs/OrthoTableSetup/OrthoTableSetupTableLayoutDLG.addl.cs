...
{
    public partial class OrthoTableSetupTableLayoutDLG : Window
	{
		...
		public void Invoke()
		{
			...
			OrthoDWGSettingsTableSetupDLG.Invoke();
			OrthoDWGSettingsTableSetupDLG.TableLayoutST.DoubleClick(MouseButton.Left, 10, 5);
			this.ListBoxLB.Select(0);
		}

		public void Dismiss()
		{
			OrthoTableSetupTableLayoutDLG OrthoTableSetupTableLayoutDLG = new OrthoTableSetupTableLayoutDLG();
			OrthoTableSetupTableLayoutDLG.CancelPB.Click();
