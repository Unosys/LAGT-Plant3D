...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class RemovePartFamilyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23071, 10, "Remove Part Family")+"|#1";
		}
		...
		public override void Invoke()
		{
			...
			AutoCADPlant3DCatalogBuilderApplicationDLG.IdDeleteFamily.Click();
			RemovePartFamilyDLG RemovePartFamilyDLG = new RemovePartFamilyDLG();
			RemovePartFamilyDLG.SetActive();
		}
