...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDPMUConnectionSucceededDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "[DialogBox]" + AcMainWin.cBabel(21059,4,"Connection Succeeded")+"|"+ AcMainWin.cBabel(23032, 3, "Connection Succeeded")+"|"+ AcMainWin.cBabel(23032, 2, "Connection Succeeded");
		}
