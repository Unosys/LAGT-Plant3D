...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupPandIDClassDefinitionDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            ProjectSetupProjectDetailsDLG.M_treeView.TypeKeys("<right>");
            System.Threading.Thread.Sleep(1000);
            //ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(21030, 1, "P&ID DWG Settings") + "/" + AcMainWin.cBabel(21013, 1, "P&ID Class Definitions") + "/" + "Engineering Items");//Engineering Items
