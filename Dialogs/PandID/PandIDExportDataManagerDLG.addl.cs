...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDExportDataManagerDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public override void Invoke()
        {
            ...
            RECT rect = DATAMANAGER.TreeViewTV.GetRect(true);
            DATAMANAGER.Click(MouseButton.Right, rect.xPos + 2, rect.yPos + 1);
            System.Threading.Thread.Sleep(100);
            DATAMANAGER.TreeViewTV.TypeKeys("<Down 2><Enter>");
            DATAMANAGER.ExportPB.Click();
            if (!this.Exists)
            {
                SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\Export.bmp");
