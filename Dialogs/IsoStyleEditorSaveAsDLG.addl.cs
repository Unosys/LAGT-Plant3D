...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class IsoStyleEditorSaveAsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		partial void OnInitialize()
		{
            ...
            {
                case "RUS":
                    Tag = "[DialogBox]" + AcMainWin.cBabel(185, 1, "Save As");
                    break;
                case "CHS":
                    Tag = "[DialogBox]" + AcMainWin.cBabel(491, 4, "Save As") + "|#1";
                    break;
                default:
                    Tag = "[DialogBox]" + AcMainWin.cBabel(491, 4, "Save As");
                    break;
            }
        ...
        public override void Invoke()
        {
            ...
            IsoStyleEditorDLG.TypeKeys("<Down 2><Enter>");//Save As
        }
