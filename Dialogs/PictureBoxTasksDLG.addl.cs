...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PictureBoxTasksDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(5);
            Desktop Desktop = new Desktop();
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\PictureBox.bmp");
            Desktop.DoubleClick(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 5, ProductTestSuite.CommonFiles.SAM.iYCoord + 5);
