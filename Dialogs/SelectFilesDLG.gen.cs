...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Files to Copy to Project", Parent = typeof(Plant3D))]
    public partial class SelectFilesDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[StaticText]File name:|#2|$13008",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[StaticText]Files of type:|#3|$13009",
                ParentType = this.GetType(),
                Parent = this
            };
