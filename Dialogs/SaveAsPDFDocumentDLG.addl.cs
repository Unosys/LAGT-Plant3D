...
{
    public partial class SaveAsPDFDocumentDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			PreviewPDFExportOptionsDLG.SetActive();
		...
		public override void Dismiss()
		{
			...
			SaveAsPDFDocumentDLG.SetActive();
			SaveAsPDFDocumentDLG.Cancel.Click();
			PreviewDLG PreviewDLG = new PreviewDLG();
			PreviewDLG.Dismiss();
		}
    }
