...
{
    public partial class dlg_vault_options : PlantVaultOptionsDLG
    {

        public dlg_vault_options() // add the constructor name as filename for each dialog
        {
            this.Information = new TestCaseInformation(
                ...
                true,
                "dlg_vault_options",//Name define by persons who edit scripts , excel?
                new List<string> {
                    "GUID-953E8475-FBF2-43EB-BE8A-041BA5648BD0"
				//Add the GUID here
				},
                FYRelease.FY16
            );
        ...
        {
            Current<PlantVaultOptionsDLG>().CaptureBitmap(SaveLocation + this.Information.Items[0].ToString() + ArtEngineConstants.BitmapExtension);
        }
