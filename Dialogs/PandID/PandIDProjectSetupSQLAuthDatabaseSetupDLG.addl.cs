...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDProjectSetupSQLAuthDatabaseSetupDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.M_tbUsrName.SetText("sa");
			PandIDProjectSetupWizardSpecifyDatabaseSettingsDLG.M_tbPwd.SetText("saPass");
			...
			if (PandIDProjectSetupWizardFinishDLG.Exists) {
                PandIDProjectSetupWizardFinishDLG.M_buttonFinish.Click();
                System.Threading.Thread.Sleep(20000);
            }
