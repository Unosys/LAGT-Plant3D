...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SelectDWGFileDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23071, 9, "Select DWG File")+"|#1";
		}
		...
		public override void Invoke()
		{
			...
			AutoCADPlant3DCatalogBuilderApplicationDLG.RadioButton2.Select();
			AutoCADPlant3DCatalogBuilderApplicationDLG.SelectDwgBtn.Click();
		}
