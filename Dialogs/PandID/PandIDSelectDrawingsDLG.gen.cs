...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Select Drawings")]
    public partial class PandIDSelectDrawingsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  PushButton SelectPB;
        public  PushButton CancelPB;
        public  ListBox LookInLB;
        public  StaticText LookInST;
        public  PopupList LookInPL;
        public  StaticText IncludeST;
        public  PopupList IncludePL;
        public  CheckBox PrefixSheetTitleWithCK;

        partial void OnInitialize();

        public PandIDSelectDrawingsDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[StaticText]File name:|$13008|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[StaticText]Files of type:|$13009|#4",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            {
                Tag = "[PopupList]Files of type:|$13002|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            ...
            SelectPB = new PushButton()
            {
                Tag = "[PushButton]Select|$1|#8",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(SelectPB);
            ...
            {
                Tag = "[StaticText]Include:|$1009|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IncludeST);

            IncludePL = new PopupList()
            {
                Tag = "[PopupList]Include:|$1008|#2",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(IncludePL);

            PrefixSheetTitleWithCK = new CheckBox()
            {
                Tag = "[CheckBox]Prefix sheet title with file name|$1010|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(PrefixSheetTitleWithCK);
        }
    }
}
