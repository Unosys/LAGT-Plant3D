...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SpecUpdateNotificationCatalogpartshavechangedDLG1 : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
			Tag = "$SpecUpdateNotificationWindow";
		}

		public override void Invoke()
		{
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
			SpecEditorDLG.OpenSpec(LAGT.CommonFiles.Product.Variables.TestFilesDir+"CS150.pspx");
			...
			SpecUpdateNotificationCatalogpartshavechangedDLG1.SetActive();
		}

		public override void Dismiss()
		{
			SpecUpdateNotificationCatalogpartshavechangedDLG1 SpecUpdateNotificationCatalogpartshavechangedDLG1 = new SpecUpdateNotificationCatalogpartshavechangedDLG1();
            SpecUpdateNotificationCatalogpartshavechangedDLG1.CancelPB.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
