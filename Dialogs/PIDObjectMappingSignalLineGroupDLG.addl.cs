...
{
    public partial class PIDObjectMappingSignalLineGroupDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  void Invoke()
        {
            ...
            try
            {
                wtreeView.Select(AcMainWin.cBabel(21100, 17, "Signal Line Group"));
            }
            catch
            {
