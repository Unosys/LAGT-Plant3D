...
{
    public partial class ill_iso_refdim_wall_type : Plant3DMainWin
    {
        private List<string> steps;

        public ill_iso_refdim_wall_type() // add the constructor name as filename for each dialog
        {
            this.Information = new TestCaseInformation(
                ...
                true,
                "ill_iso_refdim_wall_type",//Name define by persons who edit scripts , excel?
                new List<string> {
                    "GUID-DD721480-96A8-4D61-9990-7213AF44A57C"
				//Add the GUID here
				},
                FYRelease.FY16,
                true
            ...
            this.steps = new List<string> {
                "1. Move the mouse over WALL item in dynamic input",
        ...
        public override void Invoke()
        {
            ...
            Drawing.Current.TypeE("DYNMODE");
            Drawing.Current.TypeE("3");
            Drawing.Current.TypeE("_PLANTISOADDREFDIM");
