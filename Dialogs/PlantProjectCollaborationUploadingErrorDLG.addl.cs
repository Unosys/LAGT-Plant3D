...
{
    public partial class PlantProjectCollaborationUploadingErrorDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        {
            Current<PlantProjectCollaborationUploadingErrorDLG>().Close();
            ProcessStartInfo pInfo=new ProcessStartInfo();
            pInfo.FileName = @"C:\Windows\System32\ipconfig.exe";
