...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PROJECTMANAGERDLG : CustomWin
    {
        ...
        public void Invoke()//ProjectManager is dock in Plant3D
        {
        ...
        public void Undock()
        {
            ...
            PROJECTMANAGERDLG.Click(MouseButton.Left, 100,5);
            System.Threading.Thread.Sleep(1000);
            if (PROJECTMANAGERDLG.PushButton2PB.Exists)
            {
                PROJECTMANAGERDLG.DoubleClick(MouseButton.Left, 100, 5);
