...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			ProjectSetupWizardSpecifyPlant3DVaultDLG.Invoke();
            ProjectSetupWizardSpecifyPlant3DVaultDLG.SetActive();
			ProjectSetupWizardSpecifyPlant3DVaultDLG.M_buttonNext.Click();
			...
			ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG.M_comboServer.SetText("uno-03");
            //ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG.M_btnDbGenName.Click();
		...
		{
            ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG = new ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG();
            ProjectSetupWizardSpecifyDatabaseSettingsVaultDLG.M_buttonCancel.Click();
            ProjectSetupWizardPage5MSG ProjectSetupWizardPage5MSG = new ProjectSetupWizardPage5MSG();
            if (ProjectSetupWizardPage5MSG.Exists)
            {
                ProjectSetupWizardPage5MSG.YesPB.Click();
            }
		}
    }
}
