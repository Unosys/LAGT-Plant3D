...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupTitleBlockandDisplayDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
            ...
            //ProjectSetupProjectDetailsDLG.M_treeView.Select(AcMainWin.cBabel(23066, 1, "Ortho DWG Settings") + "/" + AcMainWin.cBabel(23035, 9, "Title Block and Display"));
            System.Threading.Thread.Sleep(1000);
            ProjectSetupProjectDetailsDLG.TitleBlockAndDisplay2TVI.Click();
