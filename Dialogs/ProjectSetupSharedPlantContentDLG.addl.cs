...
{
    public partial class ProjectSetupSharedPlantContentDLG : Pane
    {
        ...
        public void Dismiss()
        {
            ProjectSetupSharedPlantContentDLG ProjectSetupSharedPlantContentDLG = new ProjectSetupSharedPlantContentDLG();
            ProjectSetupSharedPlantContentDLG.CancelPB.Click();
