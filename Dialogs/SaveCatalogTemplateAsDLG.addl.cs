...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SaveCatalogTemplateAsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = AcMainWin.cBabel(23071, 6, "Save Catalog Template As")+"|#1";
		}
		...
		public override void Invoke()
		{
			...
			AutoCADPlant3DCatalogBuilderApplicationDLG.IdSaveAs.Click();
            SaveCatalogTemplateAsDLG SaveCatalogTemplateAsDLG = new SaveCatalogTemplateAsDLG();
            SaveCatalogTemplateAsDLG.SetActive();
		}

		public override void Dismiss()
		{
			SaveCatalogTemplateAsDLG SaveCatalogTemplateAsDLG = new SaveCatalogTemplateAsDLG();
			SaveCatalogTemplateAsDLG.CancelPB.Click();
			AutoCADPlant3DCatalogBuilderApplicationDLG AutoCADPlant3DCatalogBuilderApplicationDLG = new AutoCADPlant3DCatalogBuilderApplicationDLG();
