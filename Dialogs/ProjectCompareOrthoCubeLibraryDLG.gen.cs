...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    public partial class ProjectCompareOrthoCubeLibraryDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public  StaticText OrthoCubeLibrary1ST;
        ...
        public  StaticText OrthoCubeLibrary2ST;
        public  PushButton PushButton6PB;
        public  PushButton PushButton7PB;
        public  ListBox ListBoxLB;
        public  GroupBox MissingGB;
        public  ListBoxItem Area1JoggedqryLBI;
        public  StaticText Area1JoggedqryST;
        public  StaticText DetailsST;
        public  StaticText QRYFileContainingDetailsST;
        ...
        public ProjectCompareOrthoCubeLibraryDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
        ...
        private void InitializeComponent()
        {
            ...
            OrthoCubeLibrary2ST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[StaticText]OrthoCube Library|$TextBlock_1|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(OrthoCubeLibrary2ST);
            ...
            MissingGB = new GroupBox()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#1/[GroupBox]Missing|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(MissingGB);

            Area1JoggedqryLBI = new ListBoxItem()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#1/[GroupBox]#1/[ListBoxItem]#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(Area1JoggedqryLBI);

            Area1JoggedqryST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[ListBox]$ListView_1|#1/[GroupBox]Missing|#1/[ListBoxItem]Autodesk*|#1/[StaticText]Area1 Jogged*|#1",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(Area1JoggedqryST);
            ...
            QRYFileContainingDetailsST = new StaticText()
            {
                Tag = "[CustomWin]$UserControl_1|#1/[StaticText]QRY file containing details of saved Orthocube configurations*|$TextBlock_5|#3",
                ParentType = this.GetType(),
                Parent = this
            };
            DeclaredChildren.Add(QRYFileContainingDetailsST);
