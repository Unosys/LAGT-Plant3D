...
{
    public partial class ProjectSetupPipeSpecsInPIDDLG : Pane
    {
        ...
        public void Invoke()
        {
            ...
            //ProjectSetup.M_treeView.Select(AcMainWin.cBabel(21030, 1, "P&ID DWG Settings") + "/" + AcMainWin.cBabel(,,"Pipe Specs in P&ID"));
        }
