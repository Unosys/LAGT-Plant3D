...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class PandIDCloseProjectDrawingsDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[DialogBox]" + AcMainWin.cBabel(21037, 3, "Close Project Drawings");
		}
        ...
        {
            PandIDCloseProjectDrawingsDLG PandIDCloseProjectDrawingsDLG = new PandIDCloseProjectDrawingsDLG();
            PandIDCloseProjectDrawingsDLG.CancelPB.Click();
