...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]$PickListDlg", Parent = typeof(Plant3D))]
    public partial class SelectionListPropertyDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        public SelectionListPropertyDLG()
        {
            InitializeComponent();
            OnInitialize();
        }
