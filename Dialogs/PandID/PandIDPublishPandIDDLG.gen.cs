...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    ...
    [UIElement(Tag = "[DialogBox]Publish", Parent = typeof(Plant3D))]
    public partial class PandIDPublishPandIDDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Tag = "[PushButton]Publish Options|#3|$4568",
                ParentType = this.GetType(),
                Parent = this
            };
