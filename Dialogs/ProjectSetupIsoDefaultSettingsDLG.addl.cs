...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ProjectSetupIsoDefaultSettingsDLG : Pane
    {
		...
		public void Dismiss()
		{
            ProjectSetupIsoDefaultSettingsDLG ProjectSetupIsoDefaultSettingsDLG = new ProjectSetupIsoDefaultSettingsDLG();
            ProjectSetupIsoDefaultSettingsDLG.CancelPB.Click();
		}
    }
}
