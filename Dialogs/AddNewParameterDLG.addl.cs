...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class AddNewParameterDLG : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		{
            Tag = "[Pane]$ReportParameterEditorForm";
		}
		...
		public override void Invoke()
		{
            ...
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\AddParameter.bmp");
            ...
            //ReportDesignerPropertiesDLG.PopupListPL.Click();
            //ReportDesignerPropertiesDLG.PopupListPL.TypeKeys("<Home><Down 3><Enter>");
            //Desktop Desktop = new Desktop();
            //ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\AddParameter.bmp");
            //Desktop.Click(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 2, ProductTestSuite.CommonFiles.SAM.iYCoord + 2);
            //System.Threading.Thread.Sleep(1000);
            ...
            //Desktop.Click(MouseButton.Left, ProductTestSuite.CommonFiles.SAM.iXCoord + 2, ProductTestSuite.CommonFiles.SAM.iYCoord + 2);
            //System.Threading.Thread.Sleep(8000);//first"..."
        }
