...
{
    public partial class ZipCodeTasksDLG : Pane
    {
		...
		{
            Tag = "Character Comb Task|#1";//"DevExpress.XtraReports.Design.XRSmartTagService+PopupForm";
		}
        ...
        public void Invoke()
		{
            ...
            //Plant3DFunctions.StandardControls(11) Plant3DFunctions.StandardControls(11) = new Plant3DFunctions.StandardControls(11)();
            //FunctionsP3D FunctionsP3D = new FunctionsP3D();
            //Plant3DFunctions.StandardControls(11);
            System.Threading.Thread.Sleep(4000);
            Desktop Desktop = new Desktop();
            ProductTestSuite.CommonFiles.SAM.GetCoords(LAGT.CommonFiles.Product.Variables.TestFilesDir + "SamScreenshots\\CharacterComb.bmp");//CharacterComb  ZipCode
			...
			ZipCodeTasksDLG ZipCodeTasksDLG = new ZipCodeTasksDLG();
			ZipCodeTasksDLG.SetActive();
		}
