...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class SpecUtilityExportDataDLG2 : Autodesk.GUIHarness.AutoCAD.AcDialogBox
    {
		...
		public override void Invoke()
		{
			...
			SpecUtilityExportDataDLG2 SpecUtilityExportDataDLG2 = new SpecUtilityExportDataDLG2();
			SpecUtilityExportDataDLG2.SetActive();
		}
		...
		public override void Dismiss()
		{
			SpecUtilityExportDataDLG2 SpecUtilityExportDataDLG2 = new SpecUtilityExportDataDLG2();
			SpecUtilityExportDataDLG2.SetActive();
			SpecUtilityExportDataDLG2.CancelPB.Click();
			SpecEditorDLG SpecEditorDLG = new SpecEditorDLG();
			SpecEditorDLG.SetActive();
