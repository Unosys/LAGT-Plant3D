...
namespace Autodesk.GUIHarness.Plant3D.Dialogs
{
    public partial class ChartWizardSeriesViewsTrendlinesDataDLG : Pane
    {
		...
		public  void Invoke()
		{
            ...
            FibonacciIndicatorKindsDLG.ListBoxLB.Select(1);
            FibonacciIndicatorKindsDLG.OKPB.Click();
        }

		public  void Dismiss()
		{
			ChartWizardSeriesViewsTrendlinesDataDLG ChartWizardSeriesViewsTrendlinesDataDLG = new ChartWizardSeriesViewsTrendlinesDataDLG();
			ChartWizardSeriesViewsTrendlinesDataDLG.SetActive();
			ChartWizardSeriesViewsTrendlinesDataDLG.TypeKeys("<Alt-F4>");
